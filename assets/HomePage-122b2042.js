import{b as Yn,u as v,c as Vt,d as Ca,r as h,a as ce,e as Ta,f as Pn,g as ka,o as Da,j as o,R as ys,F as An,h as Nn,C as Rn,i as $r,k as vs,B as Oa,l as xs,n as ws,p as _s,M as ja,m as bs,q as Rt,t as Ss,s as Ms,A as Cs,v as mr,w as Ea,x as it,y as Ts,z as st,P as ks,D as Ds,E as Os,G as $n}from"./index-f4dcfe33.js";function Fa(e,t,r){const n=Yn(e,r),a=Yn(t,r);return+n==+a}const js=v.div`
  width: 256px;
...
`,Ls=v.div`
  ...
  align-items: center;
  gap: 12px;
`,Us=()=>{const[e,t]=h.useState(!1),{waterRate:r}=Vt(Ca),{t:n}=ce(),a=r/1e3;return o.jsxs(o.Fragment,{children:[o.jsxs(Is,{children:[o.jsx("h2",{children:n("normaModal.My daily norma")}),o.jsxs(Ls,{children:[o.jsxs("p",{children:[a," ",n("normaModal.L")]}),o.jsx("button",{onClick:()=>t(!0),children:n("edit")})]})]}),e&&o.jsx(ja,{open:e,onClose:()=>t(!1),children:o.jsx(Ws,{onClose:()=>t(!1)})})]})},Gs=v.div`
  display: flex;
  flex-direction: column;
...
`;v.p`
  font-size: 12px;
  line-height: 2;
`;const pa=20,Hc=({onClose:e})=>{const t=$r(),{t:r}=ce(),[n,a]=h.useState(250),{handleChange:i,handleSubmit:s,values:{date:u,waterAmount:d},errors:f,setFieldValue:M}=kc({initialValues:{waterAmount:"250",date:`${Rt(new Date,"HH")}:${Rt(new Date,"mm")}`},onSubmit:R=>{t(Ss(R)).unwrap().then(()=>{t(e())})}}),j=()=>{M("waterAmount",n?n.toString():"0")},g=()=>{const R=Number.parseInt(d)+pa;M("waterAmount",R.toString())},E=()=>{const R=Number.parseInt(d)-pa;M("waterAmount",R<=0?"0":R.toString())};return o.jsxs(Nc,{onSubmit:s,children:[o.jsx(Rc,{children:r("addWater")}),o.jsx($c,{children:r("addModal.Choose a value")}),o.jsxs(Vc,{children:[r("addModal.Amount of water"),":"]}),o.jsxs(Wc,{children:[o.jsxs("button",{onClick:E,name:"minus",type:"button",children:[o.jsx(Lc,{"aria-label":"minus_button"})," "]}),o.jsxs("span",{className:"water-amount-value",children:[d,r("ml")]}),o.jsxs("button",{onClick:g,name:"plus",type:"button",children:[o.jsx(Ic,{"aria-label":"plus_button"})," "]})]}),o.jsxs(Uc,{children:[o.jsxs("label",{children:[r("addModal.Recording time"),":",o.jsx("input",{name:"date",type:"time",value:u,onBlur:i}),f.date?o.jsx("div",{children:f.date}):null]}),o.jsxs("label",{children:[r("addModal.Enter the value of the water used"),":",o.jsx("input",{name:"number",value:n,onBlur:j,onChange:({target:{value:R}})=>a(Number.parseInt(R))}),f.waterAmount?o.jsx("div",{children:f.waterAmount}):null]}),o.jsxs(Gc,{children:[o.jsxs("p",{children:[d,r("ml")]}),o.jsx("button",{disabled:Object.keys(f).length>0,type:"submit",children:r("save")})]})]})]})},zc=()=>{const[n,a]=h.useState(!1),[i,s]=h.useState(!1),{t:u}=ce(),d=M=>{a(!0),s(!1),M.stopPropagation()},f=()=>{a(!1)};return o.jsxs(Gs,{children:[o.jsxs(Vs,{children:[o.jsx(Hs,{children:u("today")}),o.jsx(zs,{type:"range",min:"0",max:"100",value:85,disabled:!0}),o.jsxs(Bs,{$rater:85,children:[o.jsx("span",{children:"0%"}),o.jsx("span",{children:"50%"}),o.jsx("span",{children:"100%"})]})]}),o.jsxs(Zs,{onClick:M=>d(M),children:[o.jsx("svg",{width:24,height:24,children:o.jsx("use",{href:`${Ms}#plus-circle`})}),u("addWater")]}),n&&o.jsx(ja,{$position:"center",open:n,onClose:f,children:o.jsx(Hc,{onClose:f,isEditing:i})})]})},Bc="/capybara-components-frontend/assets/bg-home-desktop-0559d8bf.svg",Zc="/capybara-components-frontend/assets/bg-home-tablet-01106aec.svg",qc="/capybara-components-frontend/assets/bg-home-mob-0d03cb1d.svg",Kc=v(Cs)`
  display: flex;
  flex-direction: column;
  gap: 40px;
  padding-bottom: 40px;
...
`;const pm=()=>{const{t:e}=ce(),t=Vt(Rf);return o.jsx(um,{children:t.length===0?o.jsx("p",{className:"motivation",children:e("portionsText")}):o.jsxs(o.Fragment,{children:[o.jsx(dm,{children:t==null?void 0:t.map(r=>o.jsxs(cm,{children:[o.jsx(ui,{className:"glass"}),o.jsxs(fm,{children:[`${r.waterAmount} ${e("ml")}`," "]}),o.jsx(hm,{children:lm(r.date)}),o.jsx(mm,{})]},r._id))}),o.jsx(s1,{})]})})},gm=()=>{const{t:e}=ce();return o.jsxs(n1,{children:[o.jsx(a1,{children:e("today")}),o.jsx(pm,{})]})},ym=v.div`
  width: 280px;
  padding: 24px 8px;
  border-radius: 10px;
...
`,vm=()=>o.jsxs(ym,{children:[o.jsx(gm,{}),o.jsx(r1,{})]}),_m=()=>o.jsx(Qc,{id:"beckground",children:o.jsxs(Kc,{children:[o.jsxs(Jc,{children:[o.jsx(Us,{}),o.jsx(zc,{})]}),o.jsx(Xc,{children:o.jsx(vm,{})})]})});export{_m as default};
