...
`,F2=m.p`
  font-size: 12px;
  line-height: 2;
`,Oa=20,$2=({onClose:e})=>{const{t}=le(),r=St(),n=We(t1),i=We(pi).find(b=>b._id===n),[s,u]=h.useState(i.waterAmount),{handleChange:d,handleSubmit:c,values:{date:S,waterAmount:C},errors:p,setFieldValue:T}=hi({initialValues:{waterAmount:i.waterAmount.toString(),date:`${ls(i.date)}`},onSubmit:b=>{r(Rs({portionId:n,formData:b})).unwrap().then(()=>{r(e())})}}),k=()=>{T("waterAmount",s?s.toString():"0")},P=()=>{const b=Number.parseInt(C)+Oa;T("waterAmount",b.toString())},U=()=>{const b=Number.parseInt(C)-Oa;T("waterAmount",b<=0?"0":b.toString())};return o.jsxs(_2,{onSubmit:c,children:[o.jsx(S2,{children:"Edit the entered amount of water"}),o.jsxs(E2,{children:[o.jsx(C2,{}),o.jsxs(Da,{children:[" ",i.waterAmount,t("ml")]}),o.jsxs(F2,{children:[Ne(i.date,"hh"),":",Ne(i.date,"mm")," ",Ne(i.date,"a")]})]}),o.jsx(M2,{children:"Correct entered data"}),o.jsxs(Da,{children:[t("addModal.Amount of water"),":"]}),o.jsxs(T2,{children:[o.jsxs("button",{onClick:U,name:"minus",type:"button",children:[o.jsx(D2,{"aria-label":"minus_button"})," "]}),o.jsxs("span",{className:"water-amount-value",children:[C,t("ml")]}),o.jsxs("button",{onClick:P,name:"plus",type:"button",children:[o.jsx(k2,{"aria-label":"plus_button"})," "]})]}),o.jsxs(O2,{children:[o.jsxs("label",{children:[t("addModal.Recording time"),":",o.jsx("input",{name:"date",type:"time",value:S,onBlur:d}),p.date?o.jsx("div",{children:p.date}):null]}),o.jsxs("label",{children:[t("addModal.Enter the value of the water used"),":",o.jsx("input",{name:"number",value:s,onBlur:k,onChange:({target:{value:b}})=>u(Number.parseInt(b))}),p.waterAmount?o.jsx("div",{children:p.waterAmount}):null]}),o.jsxs(j2,{children:[o.jsxs("p",{children:[C,t("ml")]}),o.jsx("button",{disabled:Object.keys(p).length>0,type:"submit",children:t("save")})]})]})]})},P2=e=>h.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},h.createElement("path",{d:"M9.82667 6L9.596 12M6.404 12L6.17333 6M12.8187 3.86C13.0467 3.89466 13.2733 3.93133 13.5 3.97066M12.8187 3.86L12.1067 13.1153C12.0776 13.4921 11.9074 13.8441 11.63 14.1008C11.3527 14.3575 10.9886 14.5001 10.6107 14.5H5.38933C5.0114 14.5001 4.64735 14.3575 4.36999 14.1008C4.09262 13.8441 3.92239 13.4921 3.89333 13.1153L3.18133 3.86M12.8187 3.86C12.0492 3.74367 11.2758 3.65539 10.5 3.59533M3.18133 3.86C2.95333 3.894 2.72667 3.93066 2.5 3.97M3.18133 3.86C3.95076 3.74368 4.72416 3.6554 5.5 3.59533M10.5 3.59533V2.98466C10.5 2.198 9.89333 1.542 9.10667 1.51733C8.36908 1.49376 7.63092 1.49376 6.89333 1.51733C6.10667 1.542 5.5 2.19866 5.5 2.98466V3.59533M10.5 3.59533C8.83581 3.46672 7.16419 3.46672 5.5 3.59533",stroke:"#EF5050",strokeLinecap:"round",strokeLinejoin:"round"})),Y2=m.div`
  width: 100%;
...
`,A2=({onClose:e,id:t})=>{const r=St(),{t:n}=le();function a(){r(Is(t)).unwrap().then(()=>e())}return o.jsxs(Y2,{children:[o.jsx("h2",{children:"Delete entry"}),o.jsx("p",{className:"text",children:n("deleteQuestion")}),o.jsxs("div",{className:"wrapper-btn",children:[o.jsx("button",{onClick:e,className:"cancel-btn",children:n("cancel")}),o.jsx("button",{onClick:a,className:"delete-btn",children:n("delete")})]})]})},N2=m.button`
  padding: 0;
  border: none;
  background-color: transparent;
  position: relative;
...
`;function R2({id:e}){const[t,r]=h.useState(!1);function n(){r(!0)}return o.jsxs(o.Fragment,{children:[o.jsx(N2,{onClick:n,children:o.jsx(P2,{})}),t&&o.jsx(pt,{onClose:()=>r(!1),children:o.jsx(A2,{id:e,onClose:()=>r(!1)})})]})}const I2=()=>{const[e,t]=h.useState(null),r=We(pi),[n,a]=h.useState(!1),[i,s]=h.useState(!1),[u,d]=h.useState(!1),{t:c}=le(),S=k=>{s(!0),d(!1),k.stopPropagation()},C=(k,P)=>{a(!0),t(P),k.stopPropagation()},p=()=>{s(!1)},T=()=>{a(!1)};return o.jsxs(f2,{children:[r.length>0&&o.jsx(m2,{children:r==null?void 0:r.map(k=>o.jsxs(p2,{children:[o.jsx(Jr,{className:"glass"}),o.jsxs(g2,{children:[`${k.waterAmount} ${c("ml")}`," "]}),o.jsx(y2,{children:ls(k.date)}),o.jsxs(x2,{children:[o.jsx(w2,{onClick:P=>C(P),children:o.jsx(b2,{})}),n&&o.jsx(pt,{$position:"center",open:a,onClose:T,children:o.jsx($2,{onClose:T,isEditing:u,waterPortionId:e})}),o.jsx(R2,{id:k._id})]})]},k._id))}),o.jsxs(v2,{onClick:k=>S(k),children:[o.jsx(Kr,{}),c("addWater")]}),i&&o.jsx(pt,{$position:"center",open:i,onClose:p,children:o.jsx(mi,{onClose:p,isEditing:u})})]})},W2=()=>{const{t:e}=le();return o.jsxs(uh,{children:[o.jsx(dh,{children:e("today")}),o.jsx(I2,{})]})},L2=m.div`
  width: 280px;
  padding: 24px 8px;
  border-radius: 10px;
...
`,V2=()=>o.jsxs(L2,{children:[o.jsx(W2,{}),o.jsx(lh,{})]}),B2=()=>o.jsx(l1,{id:"beckground",children:o.jsxs(i1,{children:[o.jsxs(s1,{children:[o.jsx(Xs,{}),o.jsx(r1,{})]}),o.jsx(o1,{children:o.jsx(V2,{})})]})});export{B2 as default};
