import{u as i,c as te,b as ne,d as I,e as A,r as l,f as ie,g as re,o as ae,j as e,R as oe,F as E,h as N,B as Z,i as le,n as se,p as L,M as D,k as j,N as P,s as de,H as ce,l as pe,m as he}from"./index-081e923a.js";const xe=i.div`
...
`;const B=i.p`
  ...
  font-size: 14px;
  line-height: 1.29;
`,ye=te().shape({norma:ne().matches(/^(0\.1|[1-9](\.\d)?|1[0-4](\.\d)?|15)$/,"The amount of water must be a number in a range from 0.1 to 15 (one digit after the decimal point is allowed)").required()}),je=({onClose:t})=>{const{gender:n}=I(A),[a,r]=l.useState("0"),[s,p]=l.useState("0"),[u,h]=l.useState("1.8"),[c,m]=l.useState(()=>y()),w=ie(),{register:x,handleSubmit:g,formState:{errors:d}}=re({mode:"onChange",resolver:ae(ye)});l.useEffect(()=>{if(c&&a>0){const o=a*.03+s*.4;h(o.toFixed(1))}if(!c&&a>0){const o=a*.04+s*.6;h(o.toFixed(1))}},[a,s,u,c]);async function C(o){const O={waterRate:(o.norma*1e3).toString()};w(le(O)).unwrap().then(()=>{t()}).catch(f=>{console.log(f),se.Notify.failure(f.message,L)})}function y(){return n==="female"||n===null}function S(){return n==="female"||n===null?"female":"male"}return e.jsxs(ge,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(me,{children:[e.jsxs("p",{children:["For girl: ",e.jsx("span",{children:"V=(M*0,03) + (T*0,4)"})]}),e.jsxs("p",{children:["For man: ",e.jsx("span",{children:"V=(M*0,04) + (T*0,6)"})]})]}),e.jsxs(fe,{children:[e.jsx("span",{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]}),e.jsx("h3",{children:"Calculate your rate:"}),e.jsxs("form",{action:"",onSubmit:g(C),children:[e.jsxs(oe,{defaultValue:S(),name:"radio-buttons-group",row:!0,sx:{marginBottom:"16px"},children:[e.jsx(E,{value:"female",control:e.jsx(N,{}),label:"For woman",onChange:()=>m(!0),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25,letterSpacing:"0"},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}}),e.jsx(E,{value:"male",control:e.jsx(N,{}),label:"For man",onChange:()=>m(!1),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}})]}),e.jsxs(we,{children:[e.jsxs(W,{children:[e.jsx("label",{htmlFor:"weight",children:"Your weight in kilograms:"}),e.jsx("input",{type:"text",...x("weight"),name:"weight",id:"weight",placeholder:"0",onChange:o=>{r(o.target.value)},onFocus:o=>o.target.placeholder="",onBlur:o=>o.target.placeholder="0",onInput:o=>{o.target.value=o.target.value.replace(/(\.\d{1})\d+/,"$1"),o.target.value=o.target.value.replace(",",".")},autoComplete:"off"}),d.weight&&e.jsx(B,{children:d.weight.message})]}),e.jsxs(W,{children:[e.jsx("label",{htmlFor:"sports-time",children:"The time of active participation in sports or other activities with a high physical load in hours:"}),e.jsx("input",{type:"text",...x("sports"),name:"sports",id:"sports-time",placeholder:"0",onChange:o=>p(o.target.value),onFocus:o=>o.target.placeholder="",onBlur:o=>o.target.placeholder="0",onInput:o=>{o.target.value=o.target.value.replace(/(\.\d{1})\d+/,"$1"),o.target.value=o.target.value.replace(",",".")},autoComplete:"off"})]})]}),e.jsxs(be,{children:[e.jsx("p",{children:"The required amount of water in liters per day:"}),e.jsx("p",{children:e.jsxs("span",{children:[u," L"]})})]}),e.jsxs(Ce,{children:[e.jsx("label",{htmlFor:"norma",children:"Write down how much water you will drink:"}),e.jsx("input",{type:"text",...x("norma",{max:15}),name:"norma",id:"norma",placeholder:"0",onFocus:o=>o.target.placeholder="",onBlur:o=>o.target.placeholder="0",onInput:o=>{o.target.value=o.target.value.replace(/(\.\d{1})\d+/,"$1"),o.target.value=o.target.value.replace(",",".")},autoComplete:"off"}),d.norma&&e.jsx(B,{children:d.norma.message})]}),e.jsx(ve,{children:e.jsx(Z,{type:"submit",children:"Save"})})]})]})},Me=()=>{const[t,n]=l.useState(!1),{waterRate:a}=I(A),r=a/1e3;return e.jsxs(e.Fragment,{children:[e.jsxs(xe,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(ue,{children:[e.jsxs("p",{children:[r," L"]}),e.jsx("button",{onClick:()=>n(!0),children:"Edit"})]})]}),t&&e.jsx(D,{open:t,onClose:()=>n(!1),children:e.jsx(je,{onClose:()=>n(!1)})})]})};var V={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},H=j.createContext&&j.createContext(V),Se=["attr","size","title"];function ke(t,n){if(t==null)return{};var a=ze(t,n),r,s;if(Object.getOwnPropertySymbols){var p=Object.getOwnPropertySymbols(t);for(s=0;s<p.length;s++)r=p[s],!(n.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(a[r]=t[r])}return a}function ze(t,n){if(t==null)return{};var a={},r=Object.keys(t),s,p;for(p=0;p<r.length;p++)s=r[p],!(n.indexOf(s)>=0)&&(a[s]=t[s]);return a}function z(){return z=Object.assign?Object.assign.bind():function(t){for(var n=1;n<arguments.length;n++){var a=arguments[n];for(var r in a)Object.prototype.hasOwnProperty.call(a,r)&&(t[r]=a[r])}return t},z.apply(this,arguments)}function R(t,n){var a=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);n&&(r=r.filter(function(s){return Object.getOwnPropertyDescriptor(t,s).enumerable})),a.push.apply(a,r)}return a}function F(t){for(var n=1;n<arguments.length;n++){var a=arguments[n]!=null?arguments[n]:{};n%2?R(Object(a),!0).forEach(function(r){Fe(t,r,a[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(a)):R(Object(a)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(a,r))})}return t}function Fe(t,n,a){return n=Le(n),n in t?Object.defineProperty(t,n,{value:a,enumerable:!0,configurable:!0,writable:!0}):t[n]=a,t}function Le(t){var n=De(t,"string");return typeof n=="symbol"?n:String(n)}function De(t,n){if(typeof t!="object"||t===null)return t;var a=t[Symbol.toPrimitive];if(a!==void 0){var r=a.call(t,n||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function _(t){return t&&t.map((n,a)=>j.createElement(n.tag,F({key:a},n.attr),_(n.child)))}function M(t){return n=>j.createElement(Te,z({attr:F({},t.attr)},n),_(t.child))}function Te(t){var n=a=>{var{attr:r,size:s,title:p}=t,u=ke(t,Se),h=s||a.size||"1em",c;return a.className&&(c=a.className),t.className&&(c=(c?c+" ":"")+t.className),j.createElement("svg",z({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},a.attr,r,u,{className:c,style:F(F({color:t.color||a.color},a.style),t.style),height:h,width:h,xmlns:"http://www.w3.org/2000/svg"}),p&&j.createElement("title",null,p),t.children)};return H!==void 0?j.createElement(H.Consumer,null,a=>n(a)):n(V)}function Oe(t){return M({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"},child:[]}]})(t)}function Ee(t){return M({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"},child:[]}]})(t)}const Ne=i.div`
  display: flex;
  flex-direction: column;
  margin-top: -180px;
`,Pe=i.div`
...
`,Ze=()=>{const t=[31,28,31,30,31,30,31,31,30,31,30,31],n=[31,29,31,30,31,30,31,31,30,31,30,31],a=["January","February","March","April","May","June","Jule","August","September","October","November","December"],r=new Date,[s,p]=l.useState(r),[u,h]=l.useState(s.getDate()),[c,m]=l.useState(s.getMonth()),[w,x]=l.useState(s.getFullYear()),[g,d]=l.useState({x:0,y:0}),C=l.useRef(null);function y(f){return f%4===0&&f%100!==0||f%400===0}const S=y(s.getFullYear())?n:t,o=s.toLocaleString("en-US",{month:"long"}),T=()=>s.getMonth()===r.getMonth()&&s.getFullYear()===r.getFullYear();function O(){}return e.jsxs(Ne,{children:[e.jsxs(Pe,{children:[e.jsx(We,{children:"Month"}),e.jsxs(Re,{children:[e.jsx($,{onClick:()=>{const f=new Date(w,c-1,u);x(f.getFullYear()),m(f.getMonth()),h(f.getDate()),p(f)},children:e.jsx(Oe,{className:"nav"})}),e.jsx($e,{children:`${a[c]}, ${w}`}),e.jsx($,{onClick:()=>p(new Date(w,c+1,u)),disabled:T(),children:e.jsx(Ee,{className:"nav"})})]})]}),e.jsx(Be,{ref:C,children:S[c]?Array(S[c]).fill(null).map((f,U)=>{const b=U+1,q=b===r.getDate()&&c===r.getMonth()&&w===r.getFullYear(),J=b===u;let v=void 0;const K=b<=5||b>=11&&b<=15||b>=21&&b<=25||b===31;v||(v={percentage:0,recordsWaterConsumption:0});const Q=v.percentage>0&&v.percentage<100;return e.jsxs(He,{children:[e.jsxs(Ie,{$isToday:q,$isSelected:J,$isOutlineVisible:Q,onMouseEnter:X=>{const ee=X.target.getBoundingClientRect();d({x:g.x,y:ee.bottom})},onClick:()=>{h(b)},children:[b,e.jsx(k,{x:g.x,y:g.y,className:K?"left":"right",children:e.jsxs(e.Fragment,{children:[e.jsxs("h3",{children:[b,", ",o," "]}),e.jsxs("p",{children:["Daily norma: ",e.jsx("span",{children:v.dailyNorma})]}),e.jsxs("p",{children:["Fulfillment of the daily norm:"," ",e.jsxs("span",{children:[v.percentage,"%"]})]}),e.jsxs("p",{children:["How many servings of water:"," ",e.jsx("span",{children:v.recordsWaterConsumption})]})]})})]}),e.jsxs(Ae,{children:[v.percentage,"%"]})]},`${b}-${c+1}`)}):null})]})},Ve=i.div`
  padding: 32px 24px;
  display: flex;
  flex-direction: column;
  gap: 209px;
...
`,y1=i.p`
  font-size: 12px;
  line-height: 2;
`,G=({isEditing:t,data:n,onClose:a})=>{const[r,s]=l.useState(t?n.amountWater:0),[p,u]=l.useState(t?new Date(n.time):new Date),h=x=>{const{name:g}=x.currentTarget;switch(g){case"minus":s(d=>Math.max(d-50,0));break;case"plus":s(d=>Math.min(d+50,5e3));break}},c=x=>{const g=x.target.value,[d,C]=g.split(":").map(Number),y=new Date(p);y.setHours(d),y.setMinutes(C),u(y)},m=x=>{if(x.preventDefault(),r===0){P.Notify.warning("A non-zero value must be entered for the amount of water",L);return}if(r<0||r===""){P.Notify.warning("It is necessary to enter a positive value for the amount of water",L);return}a()},w=t?"Edit the entered amount of water":"Add water";return e.jsxs(c1,{children:[e.jsx(p1,{children:w}),e.jsx("div",{children:t&&e.jsxs(w1,{children:[e.jsx(C1,{}),e.jsxs(x1,{children:[n.amountWater,"ml"]}),e.jsx(y1,{children:new Date(n.time).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})})]})}),e.jsx(h1,{children:t?"Correct entered data:":"Choose a value:"}),e.jsx(v1,{children:"Amount of water:"}),e.jsxs(u1,{children:[e.jsx("button",{type:"button",name:"minus",onClick:h,disabled:r===0,children:e.jsx(m1,{"aria-label":"minus_button"})}),e.jsxs("span",{children:[r,"ml"]}),e.jsx("button",{type:"button",name:"plus",onClick:h,children:e.jsx(g1,{"aria-label":"plus_button"})})]}),e.jsxs(f1,{children:[e.jsxs("label",{children:["Recording time:",e.jsx("input",{type:"time",value:p.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),onChange:c})]}),e.jsxs("label",{children:["Enter the value of the water used:",e.jsx("input",{name:"input",type:"number",value:r,onChange:x=>h(x),min:"1",max:"5000"})]}),e.jsxs(b1,{children:[e.jsxs("p",{children:[r,"ml"]}),e.jsx("button",{onClick:m,children:"Save"})]})]})]})},j1=()=>{const[t,n]=l.useState(!1),[a,r]=l.useState(null),[s,p]=l.useState(!1),[u]=l.useState([]),h=d=>new Date(d).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),c=(d,C)=>{r(d),n(!0),p(!1),C.stopPropagation()},m=()=>{n(!1)},w=d=>{n(!0),p(!1),d.stopPropagation()},x=d=>{r(d)},g=u.map(d=>e.jsxs(Xe,{children:[e.jsxs(e1,{children:[e.jsxs(Ue,{children:[" ",e.jsx(Y,{})," "]}),e.jsxs(n1,{children:[d.amountWater," ml"]}),e.jsx(i1,{children:h(d.time)})]}),e.jsxs(t1,{children:[e.jsx(r1,{onClick:C=>c(d,C),children:e.jsx(Ge,{})}),e.jsx(a1,{onClick:()=>x(d),children:e.jsx(_e,{})})]})]},d._id));return e.jsxs(qe,{children:[e.jsx(Je,{children:"Today"}),e.jsxs(Ke,{children:[e.jsx(Qe,{children:(g==null?void 0:g.length)>0?g:e.jsx("li",{children:e.jsx(o1,{children:"Did you drink water today?"})})}),e.jsxs(l1,{onClick:d=>w(d),children:[e.jsx(Ye,{}),"Add water"]})]}),t&&e.jsx(D,{$position:"center",open:t,onClose:m,children:e.jsx(G,{onClose:m,isEditing:s,data:a})})]})},M1=()=>e.jsxs(Ve,{children:[e.jsx(j1,{}),e.jsx(Ze,{})]}),S1=i.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,T1=()=>{const[r,s]=l.useState(!1),[p,u]=l.useState(!1),h=m=>{s(!0),u(!1),m.stopPropagation()},c=()=>{s(!1)};return e.jsxs(S1,{children:[e.jsxs(k1,{children:[e.jsx(z1,{children:"Today"}),e.jsx(F1,{type:"range",min:"0",max:"100",value:75,disabled:!0}),e.jsxs(L1,{children:[e.jsx("span",{children:"0%"}),e.jsx("span",{children:"50%"}),e.jsx("span",{children:"100%"})]})]}),e.jsxs(D1,{onClick:m=>h(m),children:[e.jsx("svg",{width:24,height:24,children:e.jsx("use",{href:`${de}#plus-circle`})}),"Add water"]}),r&&e.jsx(D,{$position:"center",open:r,onClose:c,children:e.jsx(G,{onClose:c,isEditing:p})})]})},E1=()=>e.jsxs(ce,{children:[e.jsxs(pe,{className:"left",children:[e.jsx(Me,{}),e.jsx(T1,{})]}),e.jsx(he,{className:"right",children:e.jsx(M1,{})})]});export{E1 as default};
