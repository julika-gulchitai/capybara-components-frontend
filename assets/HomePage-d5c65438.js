import{b as An,u as p,c as tt,d as Ea,r as h,a as ce,e as Fa,f as Nn,g as $a,o as Pa,j as o,R as Cs,F as Rn,h as In,C as Wn,i as Ht,k as Ts,B as Ya,l as ks,n as Os,p as Ds,M as It,m as js,q as Ne,t as Es,s as Fs,v as $s,A as Ps,w as gr,x as Aa,y as ot,z as Ys,D as lt,P as As,E as Ns,G as Rs,H as Ln,I as Is}from"./index-dc6389ef.js";function Na(e,t,r){const n=An(e,r),a=An(t,r);return+n==+a}const Ws=p.div`
  width: 256px;
...
`,Js=p.div`
  ...
  align-items: center;
  gap: 12px;
`,Xs=()=>{const[e,t]=h.useState(!1),{waterRate:r}=tt(Ea),{t:n}=ce(),a=r/1e3;return o.jsxs(o.Fragment,{children:[o.jsxs(Ks,{children:[o.jsx("h2",{children:n("normaModal.My daily norma")}),o.jsxs(Js,{children:[o.jsxs("p",{children:[a," ",n("normaModal.L")]}),o.jsx("button",{onClick:()=>t(!0),children:n("edit")})]})]}),e&&o.jsx(It,{open:e,onClose:()=>t(!1),children:o.jsx(qs,{onClose:()=>t(!1)})})]})},Qs=p.div`
  display: flex;
  flex-direction: column;
...
`;p.p`
  font-size: 12px;
  line-height: 2;
`;const xa=20,pi=({onClose:e})=>{const t=Ht(),{t:r}=ce(),[n,a]=h.useState(250),{handleChange:i,handleSubmit:s,values:{date:u,waterAmount:d},errors:c,setFieldValue:M}=fi({initialValues:{waterAmount:"250",date:`${Ne(new Date,"HH")}:${Ne(new Date,"mm")}`},onSubmit:O=>{t(Es(O)).unwrap().then(()=>{t(e())})}}),C=()=>{M("waterAmount",n?n.toString():"0")},m=()=>{const O=Number.parseInt(d)+xa;M("waterAmount",O.toString())},T=()=>{const O=Number.parseInt(d)-xa;M("waterAmount",O<=0?"0":O.toString())};return o.jsxs(Gc,{onSubmit:s,children:[o.jsx(Bc,{children:r("addWater")}),o.jsx(Hc,{children:r("addModal.Choose a value")}),o.jsxs(Xc,{children:[r("addModal.Amount of water"),":"]}),o.jsxs(zc,{children:[o.jsxs("button",{onClick:T,name:"minus",type:"button",children:[o.jsx(qc,{"aria-label":"minus_button"})," "]}),o.jsxs("span",{className:"water-amount-value",children:[d,r("ml")]}),o.jsxs("button",{onClick:m,name:"plus",type:"button",children:[o.jsx(Zc,{"aria-label":"plus_button"})," "]})]}),o.jsxs(Kc,{children:[o.jsxs("label",{children:[r("addModal.Recording time"),":",o.jsx("input",{name:"date",type:"time",value:u,onBlur:i}),c.date?o.jsx("div",{children:c.date}):null]}),o.jsxs("label",{children:[r("addModal.Enter the value of the water used"),":",o.jsx("input",{name:"number",value:n,onBlur:C,onChange:({target:{value:O}})=>a(Number.parseInt(O))}),c.waterAmount?o.jsx("div",{children:c.waterAmount}):null]}),o.jsxs(Jc,{children:[o.jsxs("p",{children:[d,r("ml")]}),o.jsx("button",{disabled:Object.keys(c).length>0,type:"submit",children:r("save")})]})]})]})},gi=e=>e.water.waterVolumes,Qc=e=>e.water.stats,e1=e=>e.water.percentage,t1=()=>{const e=tt(e1),[t,r]=h.useState(!1),[n,a]=h.useState(!1),{t:i}=ce(),s=d=>{r(!0),a(!1),d.stopPropagation()},u=()=>{r(!1)};return o.jsxs(Qs,{children:[o.jsxs(eo,{children:[o.jsx(to,{children:i("today")}),o.jsx(ro,{type:"range",min:"0",max:"100",value:e,disabled:!0}),o.jsxs(no,{$rater:e,children:[o.jsx("span",{children:"0%"}),o.jsx("span",{children:"50%"}),o.jsx("span",{children:"100%"})]})]}),o.jsxs(ao,{onClick:d=>s(d),children:[o.jsx("svg",{width:24,height:24,children:o.jsx("use",{href:`${Fs}#plus-circle`})}),i("addWater")]}),t&&o.jsx(It,{$position:"center",open:t,onClose:u,children:o.jsx(pi,{onClose:u,isEditing:n})})]})},r1="/capybara-components-frontend/assets/bg-home-tablet-01106aec.svg",n1="/capybara-components-frontend/assets/bg-home-mob-0d03cb1d.svg",a1=p(Ps)`
  display: flex;
  flex-direction: column;
  gap: 40px;
  padding-bottom: 40px;
...
`,Am=()=>o.jsxs(Ym,{children:[o.jsx(Pm,{}),o.jsx(oh,{})]}),Im=()=>o.jsx(o1,{id:"beckground",children:o.jsxs(a1,{children:[o.jsxs(i1,{children:[o.jsx(Xs,{}),o.jsx(t1,{})]}),o.jsx(s1,{children:o.jsx(Am,{})})]})});export{Im as default};
