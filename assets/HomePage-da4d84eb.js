...
`,d1=({onClose:t})=>{const[n,o]=l.useState(0),[r,s]=l.useState(0),[c,x]=l.useState(1.8),[h,p]=l.useState(!0),{register:g,handleSubmit:f}=q({mode:"onChange"});return l.useEffect(()=>{if(h&&n>0){const a=n*.03+r*.4;x(a.toFixed(1))}if(!h&&n>0){const a=n*.04+r*.6;x(a.toFixed(1))}},[n,r,c,h]),e.jsxs(n1,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(i1,{children:[e.jsxs("p",{children:["For girl: ",e.jsx("span",{children:"V=(M*0,03) + (T*0,4)"})]}),e.jsxs("p",{children:["For man: ",e.jsx("span",{children:"V=(M*0,04) + (T*0,6)"})]})]}),e.jsxs(r1,{children:[e.jsx("span",{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]}),e.jsx("h3",{children:"Calculate your rate:"}),e.jsxs("form",{action:"",onSubmit:f(a=>{console.log(a)}),children:[e.jsxs(K,{defaultValue:"female",name:"radio-buttons-group",row:!0,sx:{marginBottom:"16px"},children:[e.jsx(F,{value:"female",control:e.jsx(L,{}),label:"For woman",onChange:()=>p(!0),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25,letterSpacing:"0"},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}}),e.jsx(F,{value:"male",control:e.jsx(L,{}),label:"For man",onChange:()=>p(!1),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}})]}),e.jsxs(a1,{children:[e.jsxs(T,{children:[e.jsx("label",{htmlFor:"weight",children:"Your weight in kilograms:"}),e.jsx("input",{type:"text",...g("weight"),name:"weight",id:"weight",placeholder:"0",onChange:a=>o(a.target.value),onFocus:a=>a.target.placeholder="",onBlur:a=>a.target.placeholder="0",autoComplete:"off"})]}),e.jsxs(T,{children:[e.jsx("label",{htmlFor:"sports-time",children:"The time of active participation in sports or other activities with a high physical load in hours:"}),e.jsx("input",{type:"text",...g("sports"),name:"sports",id:"sports-time",placeholder:"0",onChange:a=>s(a.target.value),onFocus:a=>a.target.placeholder="",onBlur:a=>a.target.placeholder="0",autoComplete:"off"})]})]}),e.jsxs(o1,{children:[e.jsx("p",{children:"The required amount of water in liters per day:"}),e.jsx("p",{children:e.jsxs("span",{children:[c," L"]})})]}),e.jsxs(l1,{children:[e.jsx("label",{htmlFor:"norma",children:"Write down how much water you will drink:"}),e.jsx("input",{type:"text",...g("norma",{max:15}),name:"norma",id:"norma",placeholder:"0",onFocus:a=>a.target.placeholder="",onBlur:a=>a.target.placeholder="0",autoComplete:"off"})]}),e.jsx(s1,{children:e.jsx(E,{type:"submit",onClick:t,children:"Save"})})]})]})},c1=()=>{const[t,n]=l.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs(e1,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(t1,{children:[e.jsx("p",{children:"1.5 L"}),e.jsx("button",{onClick:()=>n(!0),children:"Edit"})]})]}),t&&e.jsx(N,{open,onClose:()=>n(!1),children:e.jsx(d1,{onClose:()=>n(!1)})})]})};var H={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},B=y.createContext&&y.createContext(H),p1=["attr","size","title"];function h1(t,n){if(t==null)return{};var o=x1(t,n),r,s;if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(t);for(s=0;s<c.length;s++)r=c[s],!(n.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(o[r]=t[r])}return o}function x1(t,n){if(t==null)return{};var o={},r=Object.keys(t),s,c;for(c=0;c<r.length;c++)s=r[c],!(n.indexOf(s)>=0)&&(o[s]=t[s]);return o}function S(){return S=Object.assign?Object.assign.bind():function(t){for(var n=1;n<arguments.length;n++){var o=arguments[n];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(t[r]=o[r])}return t},S.apply(this,arguments)}function P(t,n){var o=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);n&&(r=r.filter(function(s){return Object.getOwnPropertyDescriptor(t,s).enumerable})),o.push.apply(o,r)}return o}function k(t){for(var n=1;n<arguments.length;n++){var o=arguments[n]!=null?arguments[n]:{};n%2?P(Object(o),!0).forEach(function(r){u1(t,r,o[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(o)):P(Object(o)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(o,r))})}return t}function u1(t,n,o){return n=m1(n),n in t?Object.defineProperty(t,n,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[n]=o,t}function m1(t){var n=g1(t,"string");return typeof n=="symbol"?n:String(n)}function g1(t,n){if(typeof t!="object"||t===null)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var r=o.call(t,n||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}function A(t){return t&&t.map((n,o)=>y.createElement(n.tag,k({key:o},n.attr),A(n.child)))}function j(t){return n=>y.createElement(f1,S({attr:k({},t.attr)},n),A(t.child))}function f1(t){var n=o=>{var{attr:r,size:s,title:c}=t,x=h1(t,p1),h=s||o.size||"1em",p;return o.className&&(p=o.className),t.className&&(p=(p?p+" ":"")+t.className),y.createElement("svg",S({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},o.attr,r,x,{className:p,style:k(k({color:t.color||o.color},o.style),t.style),height:h,width:h,xmlns:"http://www.w3.org/2000/svg"}),c&&y.createElement("title",null,c),t.children)};return B!==void 0?y.createElement(B.Consumer,null,o=>n(o)):n(H)}function b1(t){return j({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"},child:[]}]})(t)}function C1(t){return j({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"},child:[]}]})(t)}const w1=i.div`
  display: flex;
  flex-direction: column;
  margin-top: -180px;
`,y1=i.div`
...
`,L1=()=>{const t=[31,28,31,30,31,30,31,31,30,31,30,31],n=[31,29,31,30,31,30,31,31,30,31,30,31],o=["January","February","March","April","May","June","Jule","August","September","October","November","December"],r=new Date,[s,c]=l.useState(r),[x,h]=l.useState(s.getDate()),[p,g]=l.useState(s.getMonth()),[f,a]=l.useState(s.getFullYear()),[u,d]=l.useState({x:0,y:0}),w=l.useRef(null);function v(b){return b%4===0&&b%100!==0||b%400===0}const z=v(s.getFullYear())?n:t,R=s.toLocaleString("en-US",{month:"long"}),I=()=>s.getMonth()===r.getMonth()&&s.getFullYear()===r.getFullYear();function ye(){}return e.jsxs(w1,{children:[e.jsxs(y1,{children:[e.jsx(v1,{children:"Month"}),e.jsxs(S1,{children:[e.jsx(W,{onClick:()=>{const b=new Date(f,p-1,x);a(b.getFullYear()),g(b.getMonth()),h(b.getDate()),c(b)},children:e.jsx(b1,{className:"nav"})}),e.jsx(k1,{children:`${o[p]}, ${f}`}),e.jsx(W,{onClick:()=>c(new Date(f,p+1,x)),disabled:I(),children:e.jsx(C1,{className:"nav"})})]})]}),e.jsx(j1,{ref:w,children:z[p]?Array(z[p]).fill(null).map((b,$)=>{const m=$+1,V=m===r.getDate()&&p===r.getMonth()&&f===r.getFullYear(),_=m===x;let C=void 0;const Y=m<=5||m>=11&&m<=15||m>=21&&m<=25||m===31;C||(C={percentage:0,recordsWaterConsumption:0});const G=C.percentage>0&&C.percentage<100;return e.jsxs(M1,{children:[e.jsxs(z1,{$isToday:V,$isSelected:_,$isOutlineVisible:G,onMouseEnter:J=>{const U=J.target.getBoundingClientRect();d({x:u.x,y:U.bottom})},onClick:()=>{h(m)},children:[m,e.jsx(M,{x:u.x,y:u.y,className:Y?"left":"right",children:e.jsxs(e.Fragment,{children:[e.jsxs("h3",{children:[m,", ",R," "]}),e.jsxs("p",{children:["Daily norma: ",e.jsx("span",{children:C.dailyNorma})]}),e.jsxs("p",{children:["Fulfillment of the daily norm:"," ",e.jsxs("span",{children:[C.percentage,"%"]})]}),e.jsxs("p",{children:["How many servings of water:"," ",e.jsx("span",{children:C.recordsWaterConsumption})]})]})})]}),e.jsxs(F1,{children:[C.percentage,"%"]})]},`${m}-${p+1}`)}):null})]})},D1=i.div`
  padding: 32px 24px;
  display: flex;
  flex-direction: column;
  gap: 209px;
...
`,J1=t=>l.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 16 16",fill:"none",...t},l.createElement("path",{d:"M8 4V12M12 8H4",stroke:"",strokeLinecap:"round",strokeLinejoin:"round"})),U1=t=>l.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",...t},l.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5.25 12C5.25 11.8011 5.32902 11.6103 5.46967 11.4697C5.61032 11.329 5.80109 11.25 6 11.25H18C18.1989 11.25 18.3897 11.329 18.5303 11.4697C18.671 11.6103 18.75 11.8011 18.75 12C18.75 12.1989 18.671 12.3897 18.5303 12.5303C18.3897 12.671 18.1989 12.75 18 12.75H6C5.80109 12.75 5.61032 12.671 5.46967 12.5303C5.32902 12.3897 5.25 12.1989 5.25 12Z",fill:""})),q1=i.div`
  width: 100vw;
...
`,se=i.p`
  font-size: 12px;
  line-height: 2;
`,de=({isEditing:t,data:n,onClose:o})=>{const[r,s]=l.useState(t?n.amountWater:0),[c,x]=l.useState(t?new Date(n.time):new Date),h=a=>{const{name:u}=a.currentTarget;switch(u){case"minus":s(d=>Math.max(d-50,0));break;case"plus":s(d=>Math.min(d+50,5e3));break}},p=a=>{const u=a.target.value,[d,w]=u.split(":").map(Number),v=new Date(c);v.setHours(d),v.setMinutes(w),x(v)},g=a=>{if(a.preventDefault(),r===0){D.Notify.warning("A non-zero value must be entered for the amount of water",O);return}if(r<0||r===""){D.Notify.warning("It is necessary to enter a positive value for the amount of water",O);return}o()},f=t?"Edit the entered amount of water":"Add water";return e.jsxs(q1,{children:[e.jsx(K1,{children:f}),e.jsx("div",{children:t&&e.jsxs(oe,{children:[e.jsx(ae,{}),e.jsxs(X1,{children:[n.amountWater,"ml"]}),e.jsx(se,{children:new Date(n.time).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})})]})}),e.jsx(Q1,{children:t?"Correct entered data:":"Choose a value:"}),e.jsx(le,{children:"Amount of water:"}),e.jsxs(ee,{children:[e.jsx("button",{type:"button",name:"minus",onClick:h,disabled:r===0,children:e.jsx(ne,{"aria-label":"minus_button"})}),e.jsxs("span",{children:[r,"ml"]}),e.jsx("button",{type:"button",name:"plus",onClick:h,children:e.jsx(te,{"aria-label":"plus_button"})})]}),e.jsxs(ie,{children:[e.jsxs("label",{children:["Recording time:",e.jsx("input",{type:"time",value:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),onChange:p})]}),e.jsxs("label",{children:["Enter the value of the water used:",e.jsx("input",{name:"input",type:"number",value:r,onChange:a=>h(a),min:"1",max:"5000"})]}),e.jsxs(re,{children:[e.jsxs("p",{children:[r,"ml"]}),e.jsx("button",{onClick:g,children:"Save"})]})]})]})},ce=()=>{const[t,n]=l.useState(!1),[o,r]=l.useState(null),[s,c]=l.useState(!1),[x]=l.useState([]),h=d=>new Date(d).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=(d,w)=>{r(d),n(!0),c(!1),w.stopPropagation()},g=()=>{n(!1)},f=d=>{n(!0),c(!1),d.stopPropagation()},a=d=>{r(d)},u=x.map(d=>e.jsxs(A1,{children:[e.jsxs(Z1,{children:[e.jsxs(P1,{children:[" ",e.jsx(Z,{})," "]}),e.jsxs(I1,{children:[d.amountWater," ml"]}),e.jsx($1,{children:h(d.time)})]}),e.jsxs(R1,{children:[e.jsx(V1,{onClick:w=>p(d,w),children:e.jsx(B1,{})}),e.jsx(_1,{onClick:()=>a(d),children:e.jsx(O1,{})})]})]},d._id));return e.jsxs(W1,{children:[e.jsx(E1,{children:"Today"}),e.jsxs(N1,{children:[e.jsx(H1,{children:(u==null?void 0:u.length)>0?u:e.jsx("li",{children:e.jsx(Y1,{children:"Did you drink water today?"})})}),e.jsxs(G1,{onClick:d=>f(d),children:[e.jsx(T1,{}),"Add water"]})]}),t&&e.jsx(N,{$position:"center",open:t,onClose:g,children:e.jsx(de,{onClose:g,isEditing:s,data:o})})]})},pe=()=>e.jsxs(D1,{children:[e.jsx(ce,{}),e.jsx(L1,{})]}),he=i.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,fe=()=>e.jsxs(he,{children:[e.jsxs(xe,{children:[e.jsx(ue,{children:"Today"}),e.jsx("input",{type:"range",min:"0",max:"100",value:70,disabled:!0}),e.jsxs(me,{children:[e.jsx("span",{children:"0%"}),e.jsx("span",{children:"50%"}),e.jsx("span",{children:"100%"})]})]}),e.jsxs(ge,{children:[e.jsx("use",{href:`${Q}#plus-circle`}),"Add water"]})]}),be=i(X)`
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,je=()=>e.jsxs(be,{children:[e.jsxs(Ce,{className:"left",children:[e.jsx(c1,{}),e.jsx(fe,{})]}),e.jsx(we,{className:"right",children:e.jsx(pe,{})})]});export{je as default};
