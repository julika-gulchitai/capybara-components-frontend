import{u as n,c as te,a as ne,r as a,d as ie,e as $,f as I,g as re,o as oe,j as e,R as ae,F as E,h as N,B as Z,i as se,n as le,p as D,M as T,k as j,N as P,s as de,A as ce}from"./index-215ef638.js";const pe=n.div`
...
`;const B=n.p`
  ...
  font-size: 14px;
  line-height: 1.29;
`,Ce=te().shape({norma:ne().matches(/^(0\.1|[1-9](\.\d)?|1[0-4](\.\d)?|15)$/,"The amount of water must be a number in a range from 0.1 to 15 (one digit after the decimal point is allowed)").required()}),ye=({onClose:t})=>{const[i,o]=a.useState("0"),[r,s]=a.useState("0"),[d,u]=a.useState("1.8"),[h,p]=a.useState(!0),g=ie(),{gender:b}=$(I),{register:x,handleSubmit:m,formState:{errors:l}}=re({mode:"onChange",defaultValues:{},resolver:oe(Ce)});a.useEffect(()=>{if(h&&i>0){const c=i*.03+r*.4;u(c.toFixed(1))}if(!h&&i>0){const c=i*.04+r*.6;u(c.toFixed(1))}},[i,r,d,h]);async function w(c){const F={waterRate:(c.norma*1e3).toString()};g(se(F)).unwrap().then(()=>{t()}).catch(L=>{console.log(L),le.Notify.failure(L.message,D)})}function v(){return b==="female"||b===""?"female":"male"}return e.jsxs(xe,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(ue,{children:[e.jsxs("p",{children:["For girl: ",e.jsx("span",{children:"V=(M*0,03) + (T*0,4)"})]}),e.jsxs("p",{children:["For man: ",e.jsx("span",{children:"V=(M*0,04) + (T*0,6)"})]})]}),e.jsxs(me,{children:[e.jsx("span",{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]}),e.jsx("h3",{children:"Calculate your rate:"}),e.jsxs("form",{action:"",onSubmit:m(w),children:[e.jsxs(ae,{defaultValue:v(),name:"radio-buttons-group",row:!0,sx:{marginBottom:"16px"},children:[e.jsx(E,{value:"female",control:e.jsx(N,{}),label:"For woman",onChange:()=>p(!0),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25,letterSpacing:"0"},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}}),e.jsx(E,{value:"male",control:e.jsx(N,{}),label:"For man",onChange:()=>p(!1),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}})]}),e.jsxs(fe,{children:[e.jsxs(W,{children:[e.jsx("label",{htmlFor:"weight",children:"Your weight in kilograms:"}),e.jsx("input",{type:"text",...x("weight"),name:"weight",id:"weight",placeholder:"0",onChange:c=>{o(c.target.value)},onFocus:c=>c.target.placeholder="",onBlur:c=>c.target.placeholder="0",autoComplete:"off"}),l.weight&&e.jsx(B,{children:l.weight.message})]}),e.jsxs(W,{children:[e.jsx("label",{htmlFor:"sports-time",children:"The time of active participation in sports or other activities with a high physical load in hours:"}),e.jsx("input",{type:"text",...x("sports"),name:"sports",id:"sports-time",placeholder:"0",onChange:c=>s(c.target.value),onFocus:c=>c.target.placeholder="",onBlur:c=>c.target.placeholder="0",autoComplete:"off"})]})]}),e.jsxs(ge,{children:[e.jsx("p",{children:"The required amount of water in liters per day:"}),e.jsx("p",{children:e.jsxs("span",{children:[d," L"]})})]}),e.jsxs(be,{children:[e.jsx("label",{htmlFor:"norma",children:"Write down how much water you will drink:"}),e.jsx("input",{type:"text",...x("norma",{max:15}),name:"norma",id:"norma",placeholder:"0",onFocus:c=>c.target.placeholder="",onBlur:c=>c.target.placeholder="0",autoComplete:"off"}),l.norma&&e.jsx(B,{children:l.norma.message})]}),e.jsx(we,{children:e.jsx(Z,{type:"submit",children:"Save"})})]})]})},ve=()=>{const[t,i]=a.useState(!1),{waterRate:o}=$(I),r=o/1e3;return e.jsxs(e.Fragment,{children:[e.jsxs(pe,{children:[e.jsx("h2",{children:"My daily norma"}),e.jsxs(he,{children:[e.jsxs("p",{children:[r," L"]}),e.jsx("button",{onClick:()=>i(!0),children:"Edit"})]})]}),t&&e.jsx(T,{open:t,onClose:()=>i(!1),children:e.jsx(ye,{onClose:()=>i(!1)})})]})};var V={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},H=j.createContext&&j.createContext(V),je=["attr","size","title"];function Me(t,i){if(t==null)return{};var o=Se(t,i),r,s;if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(t);for(s=0;s<d.length;s++)r=d[s],!(i.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(o[r]=t[r])}return o}function Se(t,i){if(t==null)return{};var o={},r=Object.keys(t),s,d;for(d=0;d<r.length;d++)s=r[d],!(i.indexOf(s)>=0)&&(o[s]=t[s]);return o}function k(){return k=Object.assign?Object.assign.bind():function(t){for(var i=1;i<arguments.length;i++){var o=arguments[i];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(t[r]=o[r])}return t},k.apply(this,arguments)}function R(t,i){var o=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);i&&(r=r.filter(function(s){return Object.getOwnPropertyDescriptor(t,s).enumerable})),o.push.apply(o,r)}return o}function z(t){for(var i=1;i<arguments.length;i++){var o=arguments[i]!=null?arguments[i]:{};i%2?R(Object(o),!0).forEach(function(r){ke(t,r,o[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(o)):R(Object(o)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(o,r))})}return t}function ke(t,i,o){return i=ze(i),i in t?Object.defineProperty(t,i,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[i]=o,t}function ze(t){var i=Fe(t,"string");return typeof i=="symbol"?i:String(i)}function Fe(t,i){if(typeof t!="object"||t===null)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var r=o.call(t,i||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(i==="string"?String:Number)(t)}function _(t){return t&&t.map((i,o)=>j.createElement(i.tag,z({key:o},i.attr),_(i.child)))}function M(t){return i=>j.createElement(Le,k({attr:z({},t.attr)},i),_(t.child))}function Le(t){var i=o=>{var{attr:r,size:s,title:d}=t,u=Me(t,je),h=s||o.size||"1em",p;return o.className&&(p=o.className),t.className&&(p=(p?p+" ":"")+t.className),j.createElement("svg",k({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},o.attr,r,u,{className:p,style:z(z({color:t.color||o.color},o.style),t.style),height:h,width:h,xmlns:"http://www.w3.org/2000/svg"}),d&&j.createElement("title",null,d),t.children)};return H!==void 0?j.createElement(H.Consumer,null,o=>i(o)):i(V)}function De(t){return M({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"},child:[]}]})(t)}function Te(t){return M({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"},child:[]}]})(t)}const Oe=n.div`
  display: flex;
  flex-direction: column;
  margin-top: -180px;
`,Ee=n.div`
...
`,$e=()=>{const t=[31,28,31,30,31,30,31,31,30,31,30,31],i=[31,29,31,30,31,30,31,31,30,31,30,31],o=["January","February","March","April","May","June","Jule","August","September","October","November","December"],r=new Date,[s,d]=a.useState(r),[u,h]=a.useState(s.getDate()),[p,g]=a.useState(s.getMonth()),[b,x]=a.useState(s.getFullYear()),[m,l]=a.useState({x:0,y:0}),w=a.useRef(null);function v(C){return C%4===0&&C%100!==0||C%400===0}const c=v(s.getFullYear())?i:t,O=s.toLocaleString("en-US",{month:"long"}),F=()=>s.getMonth()===r.getMonth()&&s.getFullYear()===r.getFullYear();function L(){}return e.jsxs(Oe,{children:[e.jsxs(Ee,{children:[e.jsx(Ne,{children:"Month"}),e.jsxs(Be,{children:[e.jsx(A,{onClick:()=>{const C=new Date(b,p-1,u);x(C.getFullYear()),g(C.getMonth()),h(C.getDate()),d(C)},children:e.jsx(De,{className:"nav"})}),e.jsx(He,{children:`${o[p]}, ${b}`}),e.jsx(A,{onClick:()=>d(new Date(b,p+1,u)),disabled:F(),children:e.jsx(Te,{className:"nav"})})]})]}),e.jsx(Pe,{ref:w,children:c[p]?Array(c[p]).fill(null).map((C,U)=>{const f=U+1,q=f===r.getDate()&&p===r.getMonth()&&b===r.getFullYear(),J=f===u;let y=void 0;const K=f<=5||f>=11&&f<=15||f>=21&&f<=25||f===31;y||(y={percentage:0,recordsWaterConsumption:0});const Q=y.percentage>0&&y.percentage<100;return e.jsxs(We,{children:[e.jsxs(Re,{$isToday:q,$isSelected:J,$isOutlineVisible:Q,onMouseEnter:X=>{const ee=X.target.getBoundingClientRect();l({x:m.x,y:ee.bottom})},onClick:()=>{h(f)},children:[f,e.jsx(S,{x:m.x,y:m.y,className:K?"left":"right",children:e.jsxs(e.Fragment,{children:[e.jsxs("h3",{children:[f,", ",O," "]}),e.jsxs("p",{children:["Daily norma: ",e.jsx("span",{children:y.dailyNorma})]}),e.jsxs("p",{children:["Fulfillment of the daily norm:"," ",e.jsxs("span",{children:[y.percentage,"%"]})]}),e.jsxs("p",{children:["How many servings of water:"," ",e.jsx("span",{children:y.recordsWaterConsumption})]})]})})]}),e.jsxs(Ae,{children:[y.percentage,"%"]})]},`${f}-${p+1}`)}):null})]})},Ie=n.div`
  padding: 32px 24px;
  display: flex;
  flex-direction: column;
  gap: 209px;
...
`,a1=t=>a.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 16 16",fill:"none",...t},a.createElement("path",{d:"M8 4V12M12 8H4",stroke:"",strokeLinecap:"round",strokeLinejoin:"round"})),s1=t=>a.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",...t},a.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5.25 12C5.25 11.8011 5.32902 11.6103 5.46967 11.4697C5.61032 11.329 5.80109 11.25 6 11.25H18C18.1989 11.25 18.3897 11.329 18.5303 11.4697C18.671 11.6103 18.75 11.8011 18.75 12C18.75 12.1989 18.671 12.3897 18.5303 12.5303C18.3897 12.671 18.1989 12.75 18 12.75H6C5.80109 12.75 5.61032 12.671 5.46967 12.5303C5.32902 12.3897 5.25 12.1989 5.25 12Z",fill:""})),l1=n.div`
  width: 100vw;
...
`,C1=n.p`
  font-size: 12px;
  line-height: 2;
`,G=({isEditing:t,data:i,onClose:o})=>{const[r,s]=a.useState(t?i.amountWater:0),[d,u]=a.useState(t?new Date(i.time):new Date),h=x=>{const{name:m}=x.currentTarget;switch(m){case"minus":s(l=>Math.max(l-50,0));break;case"plus":s(l=>Math.min(l+50,5e3));break}},p=x=>{const m=x.target.value,[l,w]=m.split(":").map(Number),v=new Date(d);v.setHours(l),v.setMinutes(w),u(v)},g=x=>{if(x.preventDefault(),r===0){P.Notify.warning("A non-zero value must be entered for the amount of water",D);return}if(r<0||r===""){P.Notify.warning("It is necessary to enter a positive value for the amount of water",D);return}o()},b=t?"Edit the entered amount of water":"Add water";return e.jsxs(l1,{children:[e.jsx(d1,{children:b}),e.jsx("div",{children:t&&e.jsxs(f1,{children:[e.jsx(b1,{}),e.jsxs(p1,{children:[i.amountWater,"ml"]}),e.jsx(C1,{children:new Date(i.time).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})})]})}),e.jsx(c1,{children:t?"Correct entered data:":"Choose a value:"}),e.jsx(w1,{children:"Amount of water:"}),e.jsxs(h1,{children:[e.jsx("button",{type:"button",name:"minus",onClick:h,disabled:r===0,children:e.jsx(u1,{"aria-label":"minus_button"})}),e.jsxs("span",{children:[r,"ml"]}),e.jsx("button",{type:"button",name:"plus",onClick:h,children:e.jsx(x1,{"aria-label":"plus_button"})})]}),e.jsxs(m1,{children:[e.jsxs("label",{children:["Recording time:",e.jsx("input",{type:"time",value:d.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),onChange:p})]}),e.jsxs("label",{children:["Enter the value of the water used:",e.jsx("input",{name:"input",type:"number",value:r,onChange:x=>h(x),min:"1",max:"5000"})]}),e.jsxs(g1,{children:[e.jsxs("p",{children:[r,"ml"]}),e.jsx("button",{onClick:g,children:"Save"})]})]})]})},y1=()=>{const[t,i]=a.useState(!1),[o,r]=a.useState(null),[s,d]=a.useState(!1),[u]=a.useState([]),h=l=>new Date(l).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=(l,w)=>{r(l),i(!0),d(!1),w.stopPropagation()},g=()=>{i(!1)},b=l=>{i(!0),d(!1),l.stopPropagation()},x=l=>{r(l)},m=u.map(l=>e.jsxs(Ke,{children:[e.jsxs(Qe,{children:[e.jsxs(Ye,{children:[" ",e.jsx(Y,{})," "]}),e.jsxs(e1,{children:[l.amountWater," ml"]}),e.jsx(t1,{children:h(l.time)})]}),e.jsxs(Xe,{children:[e.jsx(n1,{onClick:w=>p(l,w),children:e.jsx(_e,{})}),e.jsx(i1,{onClick:()=>x(l),children:e.jsx(Ze,{})})]})]},l._id));return e.jsxs(Ge,{children:[e.jsx(Ue,{children:"Today"}),e.jsxs(qe,{children:[e.jsx(Je,{children:(m==null?void 0:m.length)>0?m:e.jsx("li",{children:e.jsx(r1,{children:"Did you drink water today?"})})}),e.jsxs(o1,{onClick:l=>b(l),children:[e.jsx(Ve,{}),"Add water"]})]}),t&&e.jsx(T,{$position:"center",open:t,onClose:g,children:e.jsx(G,{onClose:g,isEditing:s,data:o})})]})},v1=()=>e.jsxs(Ie,{children:[e.jsx(y1,{}),e.jsx($e,{})]}),j1=n.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,L1=()=>{const[r,s]=a.useState(!1),[d,u]=a.useState(!1),h=g=>{s(!0),u(!1),g.stopPropagation()},p=()=>{s(!1)};return e.jsxs(j1,{children:[e.jsxs(M1,{children:[e.jsx(S1,{children:"Today"}),e.jsx(k1,{type:"range",min:"0",max:"100",value:75,disabled:!0}),e.jsxs(z1,{children:[e.jsx("span",{children:"0%"}),e.jsx("span",{children:"50%"}),e.jsx("span",{children:"100%"})]})]}),e.jsxs(F1,{onClick:g=>h(g),children:[e.jsx("svg",{width:24,height:24,children:e.jsx("use",{href:`${de}#plus-circle`})}),"Add water"]}),r&&e.jsx(T,{$position:"center",open:r,onClose:p,children:e.jsx(G,{onClose:p,isEditing:d})})]})},D1=n(ce)`
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,N1=()=>e.jsxs(D1,{children:[e.jsxs(T1,{className:"left",children:[e.jsx(ve,{}),e.jsx(L1,{})]}),e.jsx(O1,{className:"right",children:e.jsx(v1,{})})]});export{N1 as default};
