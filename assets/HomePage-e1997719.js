import{g as qt,r as P,b as pf,_ as ki,o as ka,j as h,P as df,c as Ht,d as Na,e as Ra,f as hf,h as mf,i as vf,k as gf,l as yf,R as we,m as j,n as fr,p as Ie,q as ac,u as _,t as Kt,v as ne,a as xe,w as bf,s as Me,B as sc,x as Er,M as An,y as uc,z as Ia,C as cc,D as lc,E as wf,F as La,G as Wa,H as Fa,I as xf,J as Of,K as fc,N as Pf,O as Cf,Q as Sf,S as Ef,T as Ba,U as Tf,V as _f,W as Mf,X as $f,Y as jf,Z as Af,A as Df}from"./index-e81e0b67.js";var pc={exports:{}},kf="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",Nf=kf,Rf=Nf;function dc(){}function hc(){}hc.resetWarningCache=dc;var If=function(){function e(r,o,i,a,s,u){if(u!==Rf){var c=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw c.name="Invariant Violation",c}}e.isRequired=e;function t(){return e}var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:hc,resetWarningCache:dc};return n.PropTypes=n,n};pc.exports=If();var Lf=pc.exports;const f=qt(Lf),Wf={disableDefaultClasses:!1},Ff=P.createContext(Wf);function Bf(e){const{disableDefaultClasses:t}=P.useContext(Ff);return n=>t?"":e(n)}const mc="base";function Hf(e){return`${mc}--${e}`}function Vf(e,t){return`${mc}-${e}-${t}`}function vc(e,t){const n=pf[t];return n?Hf(n):Vf(e,t)}function zf(e,t){const n={};return t.forEach(r=>{n[r]=vc(e,r)}),n}var ie="top",ge="bottom",ye="right",ae="left",Ni="auto",Dn=[ie,ge,ye,ae],Vt="start",Pn="end",Uf="clippingParents",gc="viewport",un="popper",Yf="reference",Ha=Dn.reduce(function(e,t){return e.concat([t+"-"+Vt,t+"-"+Pn])},[]),yc=[].concat(Dn,[Ni]).reduce(function(e,t){return e.concat([t,t+"-"+Vt,t+"-"+Pn])},[]),Gf="beforeRead",Xf="read",qf="afterRead",Kf="beforeMain",Zf="main",Qf="afterMain",Jf="beforeWrite",ep="write",tp="afterWrite",np=[Gf,Xf,qf,Kf,Zf,Qf,Jf,ep,tp];function $e(e){return e?(e.nodeName||"").toLowerCase():null}function fe(e){if(e==null)return window;if(e.toString()!=="[object Window]"){var t=e.ownerDocument;return t&&t.defaultView||window}return e}function vt(e){var t=fe(e).Element;return e instanceof t||e instanceof Element}function ve(e){var t=fe(e).HTMLElement;return e instanceof t||e instanceof HTMLElement}function Ri(e){if(typeof ShadowRoot>"u")return!1;var t=fe(e).ShadowRoot;return e instanceof t||e instanceof ShadowRoot}function rp(e){var t=e.state;Object.keys(t.elements).forEach(function(n){var r=t.styles[n]||{},o=t.attributes[n]||{},i=t.elements[n];!ve(i)||!$e(i)||(Object.assign(i.style,r),Object.keys(o).forEach(function(a){var s=o[a];s===!1?i.removeAttribute(a):i.setAttribute(a,s===!0?"":s)}))})}function op(e){var t=e.state,n={popper:{position:t.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(t.elements.popper.style,n.popper),t.styles=n,t.elements.arrow&&Object.assign(t.elements.arrow.style,n.arrow),function(){Object.keys(t.elements).forEach(function(r){var o=t.elements[r],i=t.attributes[r]||{},a=Object.keys(t.styles.hasOwnProperty(r)?t.styles[r]:n[r]),s=a.reduce(function(u,c){return u[c]="",u},{});!ve(o)||!$e(o)||(Object.assign(o.style,s),Object.keys(i).forEach(function(u){o.removeAttribute(u)}))})}}const ip={name:"applyStyles",enabled:!0,phase:"write",fn:rp,effect:op,requires:["computeStyles"]};function _e(e){return e.split("-")[0]}var ht=Math.max,gr=Math.min,zt=Math.round;function zo(){var e=navigator.userAgentData;return e!=null&&e.brands&&Array.isArray(e.brands)?e.brands.map(function(t){return t.brand+"/"+t.version}).join(" "):navigator.userAgent}function bc(){return!/^((?!chrome|android).)*safari/i.test(zo())}function Ut(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!1);var r=e.getBoundingClientRect(),o=1,i=1;t&&ve(e)&&(o=e.offsetWidth>0&&zt(r.width)/e.offsetWidth||1,i=e.offsetHeight>0&&zt(r.height)/e.offsetHeight||1);var a=vt(e)?fe(e):window,s=a.visualViewport,u=!bc()&&n,c=(r.left+(u&&s?s.offsetLeft:0))/o,l=(r.top+(u&&s?s.offsetTop:0))/i,d=r.width/o,p=r.height/i;return{width:d,height:p,top:l,right:c+d,bottom:l+p,left:c,x:c,y:l}}function Ii(e){var t=Ut(e),n=e.offsetWidth,r=e.offsetHeight;return Math.abs(t.width-n)<=1&&(n=t.width),Math.abs(t.height-r)<=1&&(r=t.height),{x:e.offsetLeft,y:e.offsetTop,width:n,height:r}}function wc(e,t){var n=t.getRootNode&&t.getRootNode();if(e.contains(t))return!0;if(n&&Ri(n)){var r=t;do{if(r&&e.isSameNode(r))return!0;r=r.parentNode||r.host}while(r)}return!1}function Le(e){return fe(e).getComputedStyle(e)}function ap(e){return["table","td","th"].indexOf($e(e))>=0}function Qe(e){return((vt(e)?e.ownerDocument:e.document)||window.document).documentElement}function Tr(e){return $e(e)==="html"?e:e.assignedSlot||e.parentNode||(Ri(e)?e.host:null)||Qe(e)}function Va(e){return!ve(e)||Le(e).position==="fixed"?null:e.offsetParent}function sp(e){var t=/firefox/i.test(zo()),n=/Trident/i.test(zo());if(n&&ve(e)){var r=Le(e);if(r.position==="fixed")return null}var o=Tr(e);for(Ri(o)&&(o=o.host);ve(o)&&["html","body"].indexOf($e(o))<0;){var i=Le(o);if(i.transform!=="none"||i.perspective!=="none"||i.contain==="paint"||["transform","perspective"].indexOf(i.willChange)!==-1||t&&i.willChange==="filter"||t&&i.filter&&i.filter!=="none")return o;o=o.parentNode}return null}function kn(e){for(var t=fe(e),n=Va(e);n&&ap(n)&&Le(n).position==="static";)n=Va(n);return n&&($e(n)==="html"||$e(n)==="body"&&Le(n).position==="static")?t:n||sp(e)||t}function Li(e){return["top","bottom"].indexOf(e)>=0?"x":"y"}function yn(e,t,n){return ht(e,gr(t,n))}function up(e,t,n){var r=yn(e,t,n);return r>n?n:r}function xc(){return{top:0,right:0,bottom:0,left:0}}function Oc(e){return Object.assign({},xc(),e)}function Pc(e,t){return t.reduce(function(n,r){return n[r]=e,n},{})}var cp=function(t,n){return t=typeof t=="function"?t(Object.assign({},n.rects,{placement:n.placement})):t,Oc(typeof t!="number"?t:Pc(t,Dn))};function lp(e){var t,n=e.state,r=e.name,o=e.options,i=n.elements.arrow,a=n.modifiersData.popperOffsets,s=_e(n.placement),u=Li(s),c=[ae,ye].indexOf(s)>=0,l=c?"height":"width";if(!(!i||!a)){var d=cp(o.padding,n),p=Ii(i),m=u==="y"?ie:ae,b=u==="y"?ge:ye,g=n.rects.reference[l]+n.rects.reference[u]-a[u]-n.rects.popper[l],y=a[u]-n.rects.reference[u],v=kn(i),w=v?u==="y"?v.clientHeight||0:v.clientWidth||0:0,O=g/2-y/2,S=d[m],T=w-p[l]-d[b],C=w/2-p[l]/2+O,E=yn(S,C,T),D=u;n.modifiersData[r]=(t={},t[D]=E,t.centerOffset=E-C,t)}}function fp(e){var t=e.state,n=e.options,r=n.element,o=r===void 0?"[data-popper-arrow]":r;o!=null&&(typeof o=="string"&&(o=t.elements.popper.querySelector(o),!o)||wc(t.elements.popper,o)&&(t.elements.arrow=o))}const pp={name:"arrow",enabled:!0,phase:"main",fn:lp,effect:fp,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function Yt(e){return e.split("-")[1]}var dp={top:"auto",right:"auto",bottom:"auto",left:"auto"};function hp(e,t){var n=e.x,r=e.y,o=t.devicePixelRatio||1;return{x:zt(n*o)/o||0,y:zt(r*o)/o||0}}function za(e){var t,n=e.popper,r=e.popperRect,o=e.placement,i=e.variation,a=e.offsets,s=e.position,u=e.gpuAcceleration,c=e.adaptive,l=e.roundOffsets,d=e.isFixed,p=a.x,m=p===void 0?0:p,b=a.y,g=b===void 0?0:b,y=typeof l=="function"?l({x:m,y:g}):{x:m,y:g};m=y.x,g=y.y;var v=a.hasOwnProperty("x"),w=a.hasOwnProperty("y"),O=ae,S=ie,T=window;if(c){var C=kn(n),E="clientHeight",D="clientWidth";if(C===fe(n)&&(C=Qe(n),Le(C).position!=="static"&&s==="absolute"&&(E="scrollHeight",D="scrollWidth")),C=C,o===ie||(o===ae||o===ye)&&i===Pn){S=ge;var k=d&&C===T&&T.visualViewport?T.visualViewport.height:C[E];g-=k-r.height,g*=u?1:-1}if(o===ae||(o===ie||o===ge)&&i===Pn){O=ye;var R=d&&C===T&&T.visualViewport?T.visualViewport.width:C[D];m-=R-r.width,m*=u?1:-1}}var F=Object.assign({position:s},c&&dp),q=l===!0?hp({x:m,y:g},fe(n)):{x:m,y:g};if(m=q.x,g=q.y,u){var L;return Object.assign({},F,(L={},L[S]=w?"0":"",L[O]=v?"0":"",L.transform=(T.devicePixelRatio||1)<=1?"translate("+m+"px, "+g+"px)":"translate3d("+m+"px, "+g+"px, 0)",L))}return Object.assign({},F,(t={},t[S]=w?g+"px":"",t[O]=v?m+"px":"",t.transform="",t))}function mp(e){var t=e.state,n=e.options,r=n.gpuAcceleration,o=r===void 0?!0:r,i=n.adaptive,a=i===void 0?!0:i,s=n.roundOffsets,u=s===void 0?!0:s,c={placement:_e(t.placement),variation:Yt(t.placement),popper:t.elements.popper,popperRect:t.rects.popper,gpuAcceleration:o,isFixed:t.options.strategy==="fixed"};t.modifiersData.popperOffsets!=null&&(t.styles.popper=Object.assign({},t.styles.popper,za(Object.assign({},c,{offsets:t.modifiersData.popperOffsets,position:t.options.strategy,adaptive:a,roundOffsets:u})))),t.modifiersData.arrow!=null&&(t.styles.arrow=Object.assign({},t.styles.arrow,za(Object.assign({},c,{offsets:t.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:u})))),t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-placement":t.placement})}const vp={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:mp,data:{}};var Yn={passive:!0};function gp(e){var t=e.state,n=e.instance,r=e.options,o=r.scroll,i=o===void 0?!0:o,a=r.resize,s=a===void 0?!0:a,u=fe(t.elements.popper),c=[].concat(t.scrollParents.reference,t.scrollParents.popper);return i&&c.forEach(function(l){l.addEventListener("scroll",n.update,Yn)}),s&&u.addEventListener("resize",n.update,Yn),function(){i&&c.forEach(function(l){l.removeEventListener("scroll",n.update,Yn)}),s&&u.removeEventListener("resize",n.update,Yn)}}const yp={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:gp,data:{}};var bp={left:"right",right:"left",bottom:"top",top:"bottom"};function pr(e){return e.replace(/left|right|bottom|top/g,function(t){return bp[t]})}var wp={start:"end",end:"start"};function Ua(e){return e.replace(/start|end/g,function(t){return wp[t]})}function Wi(e){var t=fe(e),n=t.pageXOffset,r=t.pageYOffset;return{scrollLeft:n,scrollTop:r}}function Fi(e){return Ut(Qe(e)).left+Wi(e).scrollLeft}function xp(e,t){var n=fe(e),r=Qe(e),o=n.visualViewport,i=r.clientWidth,a=r.clientHeight,s=0,u=0;if(o){i=o.width,a=o.height;var c=bc();(c||!c&&t==="fixed")&&(s=o.offsetLeft,u=o.offsetTop)}return{width:i,height:a,x:s+Fi(e),y:u}}function Op(e){var t,n=Qe(e),r=Wi(e),o=(t=e.ownerDocument)==null?void 0:t.body,i=ht(n.scrollWidth,n.clientWidth,o?o.scrollWidth:0,o?o.clientWidth:0),a=ht(n.scrollHeight,n.clientHeight,o?o.scrollHeight:0,o?o.clientHeight:0),s=-r.scrollLeft+Fi(e),u=-r.scrollTop;return Le(o||n).direction==="rtl"&&(s+=ht(n.clientWidth,o?o.clientWidth:0)-i),{width:i,height:a,x:s,y:u}}function Bi(e){var t=Le(e),n=t.overflow,r=t.overflowX,o=t.overflowY;return/auto|scroll|overlay|hidden/.test(n+o+r)}function Cc(e){return["html","body","#document"].indexOf($e(e))>=0?e.ownerDocument.body:ve(e)&&Bi(e)?e:Cc(Tr(e))}function bn(e,t){var n;t===void 0&&(t=[]);var r=Cc(e),o=r===((n=e.ownerDocument)==null?void 0:n.body),i=fe(r),a=o?[i].concat(i.visualViewport||[],Bi(r)?r:[]):r,s=t.concat(a);return o?s:s.concat(bn(Tr(a)))}function Uo(e){return Object.assign({},e,{left:e.x,top:e.y,right:e.x+e.width,bottom:e.y+e.height})}function Pp(e,t){var n=Ut(e,!1,t==="fixed");return n.top=n.top+e.clientTop,n.left=n.left+e.clientLeft,n.bottom=n.top+e.clientHeight,n.right=n.left+e.clientWidth,n.width=e.clientWidth,n.height=e.clientHeight,n.x=n.left,n.y=n.top,n}function Ya(e,t,n){return t===gc?Uo(xp(e,n)):vt(t)?Pp(t,n):Uo(Op(Qe(e)))}function Cp(e){var t=bn(Tr(e)),n=["absolute","fixed"].indexOf(Le(e).position)>=0,r=n&&ve(e)?kn(e):e;return vt(r)?t.filter(function(o){return vt(o)&&wc(o,r)&&$e(o)!=="body"}):[]}function Sp(e,t,n,r){var o=t==="clippingParents"?Cp(e):[].concat(t),i=[].concat(o,[n]),a=i[0],s=i.reduce(function(u,c){var l=Ya(e,c,r);return u.top=ht(l.top,u.top),u.right=gr(l.right,u.right),u.bottom=gr(l.bottom,u.bottom),u.left=ht(l.left,u.left),u},Ya(e,a,r));return s.width=s.right-s.left,s.height=s.bottom-s.top,s.x=s.left,s.y=s.top,s}function Sc(e){var t=e.reference,n=e.element,r=e.placement,o=r?_e(r):null,i=r?Yt(r):null,a=t.x+t.width/2-n.width/2,s=t.y+t.height/2-n.height/2,u;switch(o){case ie:u={x:a,y:t.y-n.height};break;case ge:u={x:a,y:t.y+t.height};break;case ye:u={x:t.x+t.width,y:s};break;case ae:u={x:t.x-n.width,y:s};break;default:u={x:t.x,y:t.y}}var c=o?Li(o):null;if(c!=null){var l=c==="y"?"height":"width";switch(i){case Vt:u[c]=u[c]-(t[l]/2-n[l]/2);break;case Pn:u[c]=u[c]+(t[l]/2-n[l]/2);break}}return u}function Cn(e,t){t===void 0&&(t={});var n=t,r=n.placement,o=r===void 0?e.placement:r,i=n.strategy,a=i===void 0?e.strategy:i,s=n.boundary,u=s===void 0?Uf:s,c=n.rootBoundary,l=c===void 0?gc:c,d=n.elementContext,p=d===void 0?un:d,m=n.altBoundary,b=m===void 0?!1:m,g=n.padding,y=g===void 0?0:g,v=Oc(typeof y!="number"?y:Pc(y,Dn)),w=p===un?Yf:un,O=e.rects.popper,S=e.elements[b?w:p],T=Sp(vt(S)?S:S.contextElement||Qe(e.elements.popper),u,l,a),C=Ut(e.elements.reference),E=Sc({reference:C,element:O,strategy:"absolute",placement:o}),D=Uo(Object.assign({},O,E)),k=p===un?D:C,R={top:T.top-k.top+v.top,bottom:k.bottom-T.bottom+v.bottom,left:T.left-k.left+v.left,right:k.right-T.right+v.right},F=e.modifiersData.offset;if(p===un&&F){var q=F[o];Object.keys(R).forEach(function(L){var K=[ye,ge].indexOf(L)>=0?1:-1,re=[ie,ge].indexOf(L)>=0?"y":"x";R[L]+=q[re]*K})}return R}function Ep(e,t){t===void 0&&(t={});var n=t,r=n.placement,o=n.boundary,i=n.rootBoundary,a=n.padding,s=n.flipVariations,u=n.allowedAutoPlacements,c=u===void 0?yc:u,l=Yt(r),d=l?s?Ha:Ha.filter(function(b){return Yt(b)===l}):Dn,p=d.filter(function(b){return c.indexOf(b)>=0});p.length===0&&(p=d);var m=p.reduce(function(b,g){return b[g]=Cn(e,{placement:g,boundary:o,rootBoundary:i,padding:a})[_e(g)],b},{});return Object.keys(m).sort(function(b,g){return m[b]-m[g]})}function Tp(e){if(_e(e)===Ni)return[];var t=pr(e);return[Ua(e),t,Ua(t)]}function _p(e){var t=e.state,n=e.options,r=e.name;if(!t.modifiersData[r]._skip){for(var o=n.mainAxis,i=o===void 0?!0:o,a=n.altAxis,s=a===void 0?!0:a,u=n.fallbackPlacements,c=n.padding,l=n.boundary,d=n.rootBoundary,p=n.altBoundary,m=n.flipVariations,b=m===void 0?!0:m,g=n.allowedAutoPlacements,y=t.options.placement,v=_e(y),w=v===y,O=u||(w||!b?[pr(y)]:Tp(y)),S=[y].concat(O).reduce(function(Oe,ee){return Oe.concat(_e(ee)===Ni?Ep(t,{placement:ee,boundary:l,rootBoundary:d,padding:c,flipVariations:b,allowedAutoPlacements:g}):ee)},[]),T=t.rects.reference,C=t.rects.popper,E=new Map,D=!0,k=S[0],R=0;R<S.length;R++){var F=S[R],q=_e(F),L=Yt(F)===Vt,K=[ie,ge].indexOf(q)>=0,re=K?"width":"height",V=Cn(t,{placement:F,boundary:l,rootBoundary:d,altBoundary:p,padding:c}),Y=K?L?ye:ae:L?ge:ie;T[re]>C[re]&&(Y=pr(Y));var J=pr(Y),ce=[];if(i&&ce.push(V[q]<=0),s&&ce.push(V[Y]<=0,V[J]<=0),ce.every(function(Oe){return Oe})){k=F,D=!1;break}E.set(F,ce)}if(D)for(var rt=b?3:1,Be=function(ee){var He=S.find(function(Ve){var Pe=E.get(Ve);if(Pe)return Pe.slice(0,ee).every(function(Mt){return Mt})});if(He)return k=He,"break"},pe=rt;pe>0;pe--){var ot=Be(pe);if(ot==="break")break}t.placement!==k&&(t.modifiersData[r]._skip=!0,t.placement=k,t.reset=!0)}}const Mp={name:"flip",enabled:!0,phase:"main",fn:_p,requiresIfExists:["offset"],data:{_skip:!1}};function Ga(e,t,n){return n===void 0&&(n={x:0,y:0}),{top:e.top-t.height-n.y,right:e.right-t.width+n.x,bottom:e.bottom-t.height+n.y,left:e.left-t.width-n.x}}function Xa(e){return[ie,ye,ge,ae].some(function(t){return e[t]>=0})}function $p(e){var t=e.state,n=e.name,r=t.rects.reference,o=t.rects.popper,i=t.modifiersData.preventOverflow,a=Cn(t,{elementContext:"reference"}),s=Cn(t,{altBoundary:!0}),u=Ga(a,r),c=Ga(s,o,i),l=Xa(u),d=Xa(c);t.modifiersData[n]={referenceClippingOffsets:u,popperEscapeOffsets:c,isReferenceHidden:l,hasPopperEscaped:d},t.attributes.popper=Object.assign({},t.attributes.popper,{"data-popper-reference-hidden":l,"data-popper-escaped":d})}const jp={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:$p};function Ap(e,t,n){var r=_e(e),o=[ae,ie].indexOf(r)>=0?-1:1,i=typeof n=="function"?n(Object.assign({},t,{placement:e})):n,a=i[0],s=i[1];return a=a||0,s=(s||0)*o,[ae,ye].indexOf(r)>=0?{x:s,y:a}:{x:a,y:s}}function Dp(e){var t=e.state,n=e.options,r=e.name,o=n.offset,i=o===void 0?[0,0]:o,a=yc.reduce(function(l,d){return l[d]=Ap(d,t.rects,i),l},{}),s=a[t.placement],u=s.x,c=s.y;t.modifiersData.popperOffsets!=null&&(t.modifiersData.popperOffsets.x+=u,t.modifiersData.popperOffsets.y+=c),t.modifiersData[r]=a}const kp={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:Dp};function Np(e){var t=e.state,n=e.name;t.modifiersData[n]=Sc({reference:t.rects.reference,element:t.rects.popper,strategy:"absolute",placement:t.placement})}const Rp={name:"popperOffsets",enabled:!0,phase:"read",fn:Np,data:{}};function Ip(e){return e==="x"?"y":"x"}function Lp(e){var t=e.state,n=e.options,r=e.name,o=n.mainAxis,i=o===void 0?!0:o,a=n.altAxis,s=a===void 0?!1:a,u=n.boundary,c=n.rootBoundary,l=n.altBoundary,d=n.padding,p=n.tether,m=p===void 0?!0:p,b=n.tetherOffset,g=b===void 0?0:b,y=Cn(t,{boundary:u,rootBoundary:c,padding:d,altBoundary:l}),v=_e(t.placement),w=Yt(t.placement),O=!w,S=Li(v),T=Ip(S),C=t.modifiersData.popperOffsets,E=t.rects.reference,D=t.rects.popper,k=typeof g=="function"?g(Object.assign({},t.rects,{placement:t.placement})):g,R=typeof k=="number"?{mainAxis:k,altAxis:k}:Object.assign({mainAxis:0,altAxis:0},k),F=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,q={x:0,y:0};if(C){if(i){var L,K=S==="y"?ie:ae,re=S==="y"?ge:ye,V=S==="y"?"height":"width",Y=C[S],J=Y+y[K],ce=Y-y[re],rt=m?-D[V]/2:0,Be=w===Vt?E[V]:D[V],pe=w===Vt?-D[V]:-E[V],ot=t.elements.arrow,Oe=m&&ot?Ii(ot):{width:0,height:0},ee=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:xc(),He=ee[K],Ve=ee[re],Pe=yn(0,E[V],Oe[V]),Mt=O?E[V]/2-rt-Pe-He-R.mainAxis:Be-Pe-He-R.mainAxis,Vn=O?-E[V]/2+rt+Pe+Ve+R.mainAxis:pe+Pe+Ve+R.mainAxis,it=t.elements.arrow&&kn(t.elements.arrow),Jr=it?S==="y"?it.clientTop||0:it.clientLeft||0:0,an=(L=F==null?void 0:F[S])!=null?L:0,eo=Y+Mt-an-Jr,to=Y+Vn-an,zn=yn(m?gr(J,eo):J,Y,m?ht(ce,to):ce);C[S]=zn,q[S]=zn-Y}if(s){var Un,no=S==="x"?ie:ae,sn=S==="x"?ge:ye,Ae=C[T],$t=T==="y"?"height":"width",x=Ae+y[no],M=Ae-y[sn],$=[ie,ae].indexOf(v)!==-1,A=(Un=F==null?void 0:F[T])!=null?Un:0,I=$?x:Ae-E[$t]-D[$t]-A+R.altAxis,W=$?Ae+E[$t]+D[$t]-A-R.altAxis:M,U=m&&$?up(I,Ae,W):yn(m?I:x,Ae,m?W:M);C[T]=U,q[T]=U-Ae}t.modifiersData[r]=q}}const Wp={name:"preventOverflow",enabled:!0,phase:"main",fn:Lp,requiresIfExists:["offset"]};function Fp(e){return{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}}function Bp(e){return e===fe(e)||!ve(e)?Wi(e):Fp(e)}function Hp(e){var t=e.getBoundingClientRect(),n=zt(t.width)/e.offsetWidth||1,r=zt(t.height)/e.offsetHeight||1;return n!==1||r!==1}function Vp(e,t,n){n===void 0&&(n=!1);var r=ve(t),o=ve(t)&&Hp(t),i=Qe(t),a=Ut(e,o,n),s={scrollLeft:0,scrollTop:0},u={x:0,y:0};return(r||!r&&!n)&&(($e(t)!=="body"||Bi(i))&&(s=Bp(t)),ve(t)?(u=Ut(t,!0),u.x+=t.clientLeft,u.y+=t.clientTop):i&&(u.x=Fi(i))),{x:a.left+s.scrollLeft-u.x,y:a.top+s.scrollTop-u.y,width:a.width,height:a.height}}function zp(e){var t=new Map,n=new Set,r=[];e.forEach(function(i){t.set(i.name,i)});function o(i){n.add(i.name);var a=[].concat(i.requires||[],i.requiresIfExists||[]);a.forEach(function(s){if(!n.has(s)){var u=t.get(s);u&&o(u)}}),r.push(i)}return e.forEach(function(i){n.has(i.name)||o(i)}),r}function Up(e){var t=zp(e);return np.reduce(function(n,r){return n.concat(t.filter(function(o){return o.phase===r}))},[])}function Yp(e){var t;return function(){return t||(t=new Promise(function(n){Promise.resolve().then(function(){t=void 0,n(e())})})),t}}function Gp(e){var t=e.reduce(function(n,r){var o=n[r.name];return n[r.name]=o?Object.assign({},o,r,{options:Object.assign({},o.options,r.options),data:Object.assign({},o.data,r.data)}):r,n},{});return Object.keys(t).map(function(n){return t[n]})}var qa={placement:"bottom",modifiers:[],strategy:"absolute"};function Ka(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return!t.some(function(r){return!(r&&typeof r.getBoundingClientRect=="function")})}function Xp(e){e===void 0&&(e={});var t=e,n=t.defaultModifiers,r=n===void 0?[]:n,o=t.defaultOptions,i=o===void 0?qa:o;return function(s,u,c){c===void 0&&(c=i);var l={placement:"bottom",orderedModifiers:[],options:Object.assign({},qa,i),modifiersData:{},elements:{reference:s,popper:u},attributes:{},styles:{}},d=[],p=!1,m={state:l,setOptions:function(v){var w=typeof v=="function"?v(l.options):v;g(),l.options=Object.assign({},i,l.options,w),l.scrollParents={reference:vt(s)?bn(s):s.contextElement?bn(s.contextElement):[],popper:bn(u)};var O=Up(Gp([].concat(r,l.options.modifiers)));return l.orderedModifiers=O.filter(function(S){return S.enabled}),b(),m.update()},forceUpdate:function(){if(!p){var v=l.elements,w=v.reference,O=v.popper;if(Ka(w,O)){l.rects={reference:Vp(w,kn(O),l.options.strategy==="fixed"),popper:Ii(O)},l.reset=!1,l.placement=l.options.placement,l.orderedModifiers.forEach(function(R){return l.modifiersData[R.name]=Object.assign({},R.data)});for(var S=0;S<l.orderedModifiers.length;S++){if(l.reset===!0){l.reset=!1,S=-1;continue}var T=l.orderedModifiers[S],C=T.fn,E=T.options,D=E===void 0?{}:E,k=T.name;typeof C=="function"&&(l=C({state:l,options:D,name:k,instance:m})||l)}}}},update:Yp(function(){return new Promise(function(y){m.forceUpdate(),y(l)})}),destroy:function(){g(),p=!0}};if(!Ka(s,u))return m;m.setOptions(c).then(function(y){!p&&c.onFirstUpdate&&c.onFirstUpdate(y)});function b(){l.orderedModifiers.forEach(function(y){var v=y.name,w=y.options,O=w===void 0?{}:w,S=y.effect;if(typeof S=="function"){var T=S({state:l,name:v,instance:m,options:O}),C=function(){};d.push(T||C)}})}function g(){d.forEach(function(y){return y()}),d=[]}return m}}var qp=[yp,Rp,vp,ip,kp,Mp,Wp,pp,jp],Kp=Xp({defaultModifiers:qp});const Ec="Popper";function Zp(e){return vc(Ec,e)}zf(Ec,["root"]);const Qp=["anchorEl","children","direction","disablePortal","modifiers","open","placement","popperOptions","popperRef","slotProps","slots","TransitionProps","ownerState"],Jp=["anchorEl","children","container","direction","disablePortal","keepMounted","modifiers","open","placement","popperOptions","popperRef","style","transition","slotProps","slots"];function ed(e,t){if(t==="ltr")return e;switch(e){case"bottom-end":return"bottom-start";case"bottom-start":return"bottom-end";case"top-end":return"top-start";case"top-start":return"top-end";default:return e}}function Yo(e){return typeof e=="function"?e():e}function td(e){return e.nodeType!==void 0}const nd=()=>mf({root:["root"]},Bf(Zp)),rd={},od=P.forwardRef(function(t,n){var r;const{anchorEl:o,children:i,direction:a,disablePortal:s,modifiers:u,open:c,placement:l,popperOptions:d,popperRef:p,slotProps:m={},slots:b={},TransitionProps:g}=t,y=ki(t,Qp),v=P.useRef(null),w=Na(v,n),O=P.useRef(null),S=Na(O,p),T=P.useRef(S);Ra(()=>{T.current=S},[S]),P.useImperativeHandle(p,()=>O.current,[]);const C=ed(l,a),[E,D]=P.useState(C),[k,R]=P.useState(Yo(o));P.useEffect(()=>{O.current&&O.current.forceUpdate()}),P.useEffect(()=>{o&&R(Yo(o))},[o]),Ra(()=>{if(!k||!c)return;const re=J=>{D(J.placement)};let V=[{name:"preventOverflow",options:{altBoundary:s}},{name:"flip",options:{altBoundary:s}},{name:"onUpdate",enabled:!0,phase:"afterWrite",fn:({state:J})=>{re(J)}}];u!=null&&(V=V.concat(u)),d&&d.modifiers!=null&&(V=V.concat(d.modifiers));const Y=Kp(k,v.current,Ht({placement:C},d,{modifiers:V}));return T.current(Y),()=>{Y.destroy(),T.current(null)}},[k,s,u,c,d,C]);const F={placement:E};g!==null&&(F.TransitionProps=g);const q=nd(),L=(r=b.root)!=null?r:"div",K=hf({elementType:L,externalSlotProps:m.root,externalForwardedProps:y,additionalProps:{role:"tooltip",ref:w},ownerState:t,className:q.root});return h.jsx(L,Ht({},K,{children:typeof i=="function"?i(F):i}))}),id=P.forwardRef(function(t,n){const{anchorEl:r,children:o,container:i,direction:a="ltr",disablePortal:s=!1,keepMounted:u=!1,modifiers:c,open:l,placement:d="bottom",popperOptions:p=rd,popperRef:m,style:b,transition:g=!1,slotProps:y={},slots:v={}}=t,w=ki(t,Jp),[O,S]=P.useState(!0),T=()=>{S(!1)},C=()=>{S(!0)};if(!u&&!l&&(!g||O))return null;let E;if(i)E=i;else if(r){const R=Yo(r);E=R&&td(R)?ka(R).body:ka(null).body}const D=!l&&u&&(!g||O)?"none":void 0,k=g?{in:l,onEnter:T,onExited:C}:void 0;return h.jsx(df,{disablePortal:s,container:E,children:h.jsx(od,Ht({anchorEl:r,direction:a,disablePortal:s,modifiers:c,ref:n,open:g?!O:l,placement:d,popperOptions:p,popperRef:m,slotProps:y,slots:v},w,{style:Ht({position:"fixed",top:0,left:0,display:D},b),TransitionProps:k,children:o}))})});var Hi={};Object.defineProperty(Hi,"__esModule",{value:!0});var Tc=Hi.default=void 0,ad=ud(P),sd=vf;function _c(e){if(typeof WeakMap!="function")return null;var t=new WeakMap,n=new WeakMap;return(_c=function(r){return r?n:t})(e)}function ud(e,t){if(!t&&e&&e.__esModule)return e;if(e===null||typeof e!="object"&&typeof e!="function")return{default:e};var n=_c(t);if(n&&n.has(e))return n.get(e);var r={__proto__:null},o=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var i in e)if(i!=="default"&&Object.prototype.hasOwnProperty.call(e,i)){var a=o?Object.getOwnPropertyDescriptor(e,i):null;a&&(a.get||a.set)?Object.defineProperty(r,i,a):r[i]=e[i]}return r.default=e,n&&n.set(e,r),r}function cd(e){return Object.keys(e).length===0}function ld(e=null){const t=ad.useContext(sd.ThemeContext);return!t||cd(t)?e:t}Tc=Hi.default=ld;const fd=["anchorEl","component","components","componentsProps","container","disablePortal","keepMounted","modifiers","open","placement","popperOptions","popperRef","transition","slots","slotProps"],pd=gf(id,{name:"MuiPopper",slot:"Root",overridesResolver:(e,t)=>t.root})({}),dd=P.forwardRef(function(t,n){var r;const o=Tc(),i=yf({props:t,name:"MuiPopper"}),{anchorEl:a,component:s,components:u,componentsProps:c,container:l,disablePortal:d,keepMounted:p,modifiers:m,open:b,placement:g,popperOptions:y,popperRef:v,transition:w,slots:O,slotProps:S}=i,T=ki(i,fd),C=(r=O==null?void 0:O.root)!=null?r:u==null?void 0:u.Root,E=Ht({anchorEl:a,container:l,disablePortal:d,keepMounted:p,modifiers:m,open:b,placement:g,popperOptions:y,popperRef:v,transition:w},T);return h.jsx(pd,Ht({as:s,direction:o==null?void 0:o.direction,slots:{root:C},slotProps:S??c},E,{ref:n}))}),hd=dd,Vi=e=>e.water.waterVolumes,md=e=>e.water.waterVolumeSum,vd=e=>e.water.stats,_r=e=>e.water.selectedCalendar;var gd=function(t){return yd(t)&&!bd(t)};function yd(e){return!!e&&typeof e=="object"}function bd(e){var t=Object.prototype.toString.call(e);return t==="[object RegExp]"||t==="[object Date]"||Od(e)}var wd=typeof Symbol=="function"&&Symbol.for,xd=wd?Symbol.for("react.element"):60103;function Od(e){return e.$$typeof===xd}function Pd(e){return Array.isArray(e)?[]:{}}function yr(e,t){return t.clone!==!1&&t.isMergeableObject(e)?Sn(Pd(e),e,t):e}function Cd(e,t,n){return e.concat(t).map(function(r){return yr(r,n)})}function Sd(e,t,n){var r={};return n.isMergeableObject(e)&&Object.keys(e).forEach(function(o){r[o]=yr(e[o],n)}),Object.keys(t).forEach(function(o){!n.isMergeableObject(t[o])||!e[o]?r[o]=yr(t[o],n):r[o]=Sn(e[o],t[o],n)}),r}function Sn(e,t,n){n=n||{},n.arrayMerge=n.arrayMerge||Cd,n.isMergeableObject=n.isMergeableObject||gd;var r=Array.isArray(t),o=Array.isArray(e),i=r===o;return i?r?n.arrayMerge(e,t,n):Sd(e,t,n):yr(t,n)}Sn.all=function(t,n){if(!Array.isArray(t))throw new Error("first argument should be an array");return t.reduce(function(r,o){return Sn(r,o,n)},{})};var Go=Sn,Ed=typeof global=="object"&&global&&global.Object===Object&&global;const Mc=Ed;var Td=typeof self=="object"&&self&&self.Object===Object&&self,_d=Mc||Td||Function("return this")();const je=_d;var Md=je.Symbol;const Xe=Md;var $c=Object.prototype,$d=$c.hasOwnProperty,jd=$c.toString,cn=Xe?Xe.toStringTag:void 0;function Ad(e){var t=$d.call(e,cn),n=e[cn];try{e[cn]=void 0;var r=!0}catch{}var o=jd.call(e);return r&&(t?e[cn]=n:delete e[cn]),o}var Dd=Object.prototype,kd=Dd.toString;function Nd(e){return kd.call(e)}var Rd="[object Null]",Id="[object Undefined]",Za=Xe?Xe.toStringTag:void 0;function xt(e){return e==null?e===void 0?Id:Rd:Za&&Za in Object(e)?Ad(e):Nd(e)}function jc(e,t){return function(n){return e(t(n))}}var Ld=jc(Object.getPrototypeOf,Object);const zi=Ld;function Ot(e){return e!=null&&typeof e=="object"}var Wd="[object Object]",Fd=Function.prototype,Bd=Object.prototype,Ac=Fd.toString,Hd=Bd.hasOwnProperty,Vd=Ac.call(Object);function Qa(e){if(!Ot(e)||xt(e)!=Wd)return!1;var t=zi(e);if(t===null)return!0;var n=Hd.call(t,"constructor")&&t.constructor;return typeof n=="function"&&n instanceof n&&Ac.call(n)==Vd}var Ja=Array.isArray,es=Object.keys,zd=Object.prototype.hasOwnProperty,Ud=typeof Element<"u";function Xo(e,t){if(e===t)return!0;if(e&&t&&typeof e=="object"&&typeof t=="object"){var n=Ja(e),r=Ja(t),o,i,a;if(n&&r){if(i=e.length,i!=t.length)return!1;for(o=i;o--!==0;)if(!Xo(e[o],t[o]))return!1;return!0}if(n!=r)return!1;var s=e instanceof Date,u=t instanceof Date;if(s!=u)return!1;if(s&&u)return e.getTime()==t.getTime();var c=e instanceof RegExp,l=t instanceof RegExp;if(c!=l)return!1;if(c&&l)return e.toString()==t.toString();var d=es(e);if(i=d.length,i!==es(t).length)return!1;for(o=i;o--!==0;)if(!zd.call(t,d[o]))return!1;if(Ud&&e instanceof Element&&t instanceof Element)return e===t;for(o=i;o--!==0;)if(a=d[o],!(a==="_owner"&&e.$$typeof)&&!Xo(e[a],t[a]))return!1;return!0}return e!==e&&t!==t}var Yd=function(t,n){try{return Xo(t,n)}catch(r){if(r.message&&r.message.match(/stack|recursion/i)||r.number===-2146828260)return console.warn("Warning: react-fast-compare does not handle circular references.",r.name,r.message),!1;throw r}};const lt=qt(Yd);var Gd=!0;function Xd(e,t){if(!Gd){if(e)return;var n="Warning: "+t;typeof console<"u"&&console.warn(n);try{throw Error(n)}catch{}}}function qd(){this.__data__=[],this.size=0}function Dc(e,t){return e===t||e!==e&&t!==t}function Mr(e,t){for(var n=e.length;n--;)if(Dc(e[n][0],t))return n;return-1}var Kd=Array.prototype,Zd=Kd.splice;function Qd(e){var t=this.__data__,n=Mr(t,e);if(n<0)return!1;var r=t.length-1;return n==r?t.pop():Zd.call(t,n,1),--this.size,!0}function Jd(e){var t=this.__data__,n=Mr(t,e);return n<0?void 0:t[n][1]}function eh(e){return Mr(this.__data__,e)>-1}function th(e,t){var n=this.__data__,r=Mr(n,e);return r<0?(++this.size,n.push([e,t])):n[r][1]=t,this}function Fe(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}Fe.prototype.clear=qd;Fe.prototype.delete=Qd;Fe.prototype.get=Jd;Fe.prototype.has=eh;Fe.prototype.set=th;function nh(){this.__data__=new Fe,this.size=0}function rh(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}function oh(e){return this.__data__.get(e)}function ih(e){return this.__data__.has(e)}function Nn(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}var ah="[object AsyncFunction]",sh="[object Function]",uh="[object GeneratorFunction]",ch="[object Proxy]";function kc(e){if(!Nn(e))return!1;var t=xt(e);return t==sh||t==uh||t==ah||t==ch}var lh=je["__core-js_shared__"];const io=lh;var ts=function(){var e=/[^.]+$/.exec(io&&io.keys&&io.keys.IE_PROTO||"");return e?"Symbol(src)_1."+e:""}();function fh(e){return!!ts&&ts in e}var ph=Function.prototype,dh=ph.toString;function Pt(e){if(e!=null){try{return dh.call(e)}catch{}try{return e+""}catch{}}return""}var hh=/[\\^$.*+?()[\]{}|]/g,mh=/^\[object .+?Constructor\]$/,vh=Function.prototype,gh=Object.prototype,yh=vh.toString,bh=gh.hasOwnProperty,wh=RegExp("^"+yh.call(bh).replace(hh,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function xh(e){if(!Nn(e)||fh(e))return!1;var t=kc(e)?wh:mh;return t.test(Pt(e))}function Oh(e,t){return e==null?void 0:e[t]}function Ct(e,t){var n=Oh(e,t);return xh(n)?n:void 0}var Ph=Ct(je,"Map");const En=Ph;var Ch=Ct(Object,"create");const Tn=Ch;function Sh(){this.__data__=Tn?Tn(null):{},this.size=0}function Eh(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}var Th="__lodash_hash_undefined__",_h=Object.prototype,Mh=_h.hasOwnProperty;function $h(e){var t=this.__data__;if(Tn){var n=t[e];return n===Th?void 0:n}return Mh.call(t,e)?t[e]:void 0}var jh=Object.prototype,Ah=jh.hasOwnProperty;function Dh(e){var t=this.__data__;return Tn?t[e]!==void 0:Ah.call(t,e)}var kh="__lodash_hash_undefined__";function Nh(e,t){var n=this.__data__;return this.size+=this.has(e)?0:1,n[e]=Tn&&t===void 0?kh:t,this}function gt(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}gt.prototype.clear=Sh;gt.prototype.delete=Eh;gt.prototype.get=$h;gt.prototype.has=Dh;gt.prototype.set=Nh;function Rh(){this.size=0,this.__data__={hash:new gt,map:new(En||Fe),string:new gt}}function Ih(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}function $r(e,t){var n=e.__data__;return Ih(t)?n[typeof t=="string"?"string":"hash"]:n.map}function Lh(e){var t=$r(this,e).delete(e);return this.size-=t?1:0,t}function Wh(e){return $r(this,e).get(e)}function Fh(e){return $r(this,e).has(e)}function Bh(e,t){var n=$r(this,e),r=n.size;return n.set(e,t),this.size+=n.size==r?0:1,this}function Je(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}Je.prototype.clear=Rh;Je.prototype.delete=Lh;Je.prototype.get=Wh;Je.prototype.has=Fh;Je.prototype.set=Bh;var Hh=200;function Vh(e,t){var n=this.__data__;if(n instanceof Fe){var r=n.__data__;if(!En||r.length<Hh-1)return r.push([e,t]),this.size=++n.size,this;n=this.__data__=new Je(r)}return n.set(e,t),this.size=n.size,this}function Zt(e){var t=this.__data__=new Fe(e);this.size=t.size}Zt.prototype.clear=nh;Zt.prototype.delete=rh;Zt.prototype.get=oh;Zt.prototype.has=ih;Zt.prototype.set=Vh;function zh(e,t){for(var n=-1,r=e==null?0:e.length;++n<r&&t(e[n],n,e)!==!1;);return e}var Uh=function(){try{var e=Ct(Object,"defineProperty");return e({},"",{}),e}catch{}}();const ns=Uh;function Nc(e,t,n){t=="__proto__"&&ns?ns(e,t,{configurable:!0,enumerable:!0,value:n,writable:!0}):e[t]=n}var Yh=Object.prototype,Gh=Yh.hasOwnProperty;function Rc(e,t,n){var r=e[t];(!(Gh.call(e,t)&&Dc(r,n))||n===void 0&&!(t in e))&&Nc(e,t,n)}function jr(e,t,n,r){var o=!n;n||(n={});for(var i=-1,a=t.length;++i<a;){var s=t[i],u=r?r(n[s],e[s],s,n,e):void 0;u===void 0&&(u=e[s]),o?Nc(n,s,u):Rc(n,s,u)}return n}function Xh(e,t){for(var n=-1,r=Array(e);++n<e;)r[n]=t(n);return r}var qh="[object Arguments]";function rs(e){return Ot(e)&&xt(e)==qh}var Ic=Object.prototype,Kh=Ic.hasOwnProperty,Zh=Ic.propertyIsEnumerable,Qh=rs(function(){return arguments}())?rs:function(e){return Ot(e)&&Kh.call(e,"callee")&&!Zh.call(e,"callee")};const Jh=Qh;var em=Array.isArray;const Rn=em;function tm(){return!1}var Lc=typeof exports=="object"&&exports&&!exports.nodeType&&exports,os=Lc&&typeof module=="object"&&module&&!module.nodeType&&module,nm=os&&os.exports===Lc,is=nm?je.Buffer:void 0,rm=is?is.isBuffer:void 0,om=rm||tm;const Wc=om;var im=9007199254740991,am=/^(?:0|[1-9]\d*)$/;function sm(e,t){var n=typeof e;return t=t??im,!!t&&(n=="number"||n!="symbol"&&am.test(e))&&e>-1&&e%1==0&&e<t}var um=9007199254740991;function Fc(e){return typeof e=="number"&&e>-1&&e%1==0&&e<=um}var cm="[object Arguments]",lm="[object Array]",fm="[object Boolean]",pm="[object Date]",dm="[object Error]",hm="[object Function]",mm="[object Map]",vm="[object Number]",gm="[object Object]",ym="[object RegExp]",bm="[object Set]",wm="[object String]",xm="[object WeakMap]",Om="[object ArrayBuffer]",Pm="[object DataView]",Cm="[object Float32Array]",Sm="[object Float64Array]",Em="[object Int8Array]",Tm="[object Int16Array]",_m="[object Int32Array]",Mm="[object Uint8Array]",$m="[object Uint8ClampedArray]",jm="[object Uint16Array]",Am="[object Uint32Array]",z={};z[Cm]=z[Sm]=z[Em]=z[Tm]=z[_m]=z[Mm]=z[$m]=z[jm]=z[Am]=!0;z[cm]=z[lm]=z[Om]=z[fm]=z[Pm]=z[pm]=z[dm]=z[hm]=z[mm]=z[vm]=z[gm]=z[ym]=z[bm]=z[wm]=z[xm]=!1;function Dm(e){return Ot(e)&&Fc(e.length)&&!!z[xt(e)]}function Ui(e){return function(t){return e(t)}}var Bc=typeof exports=="object"&&exports&&!exports.nodeType&&exports,wn=Bc&&typeof module=="object"&&module&&!module.nodeType&&module,km=wn&&wn.exports===Bc,ao=km&&Mc.process,Nm=function(){try{var e=wn&&wn.require&&wn.require("util").types;return e||ao&&ao.binding&&ao.binding("util")}catch{}}();const Gt=Nm;var as=Gt&&Gt.isTypedArray,Rm=as?Ui(as):Dm;const Im=Rm;var Lm=Object.prototype,Wm=Lm.hasOwnProperty;function Hc(e,t){var n=Rn(e),r=!n&&Jh(e),o=!n&&!r&&Wc(e),i=!n&&!r&&!o&&Im(e),a=n||r||o||i,s=a?Xh(e.length,String):[],u=s.length;for(var c in e)(t||Wm.call(e,c))&&!(a&&(c=="length"||o&&(c=="offset"||c=="parent")||i&&(c=="buffer"||c=="byteLength"||c=="byteOffset")||sm(c,u)))&&s.push(c);return s}var Fm=Object.prototype;function Yi(e){var t=e&&e.constructor,n=typeof t=="function"&&t.prototype||Fm;return e===n}var Bm=jc(Object.keys,Object);const Hm=Bm;var Vm=Object.prototype,zm=Vm.hasOwnProperty;function Um(e){if(!Yi(e))return Hm(e);var t=[];for(var n in Object(e))zm.call(e,n)&&n!="constructor"&&t.push(n);return t}function Vc(e){return e!=null&&Fc(e.length)&&!kc(e)}function Gi(e){return Vc(e)?Hc(e):Um(e)}function Ym(e,t){return e&&jr(t,Gi(t),e)}function Gm(e){var t=[];if(e!=null)for(var n in Object(e))t.push(n);return t}var Xm=Object.prototype,qm=Xm.hasOwnProperty;function Km(e){if(!Nn(e))return Gm(e);var t=Yi(e),n=[];for(var r in e)r=="constructor"&&(t||!qm.call(e,r))||n.push(r);return n}function Xi(e){return Vc(e)?Hc(e,!0):Km(e)}function Zm(e,t){return e&&jr(t,Xi(t),e)}var zc=typeof exports=="object"&&exports&&!exports.nodeType&&exports,ss=zc&&typeof module=="object"&&module&&!module.nodeType&&module,Qm=ss&&ss.exports===zc,us=Qm?je.Buffer:void 0,cs=us?us.allocUnsafe:void 0;function Jm(e,t){if(t)return e.slice();var n=e.length,r=cs?cs(n):new e.constructor(n);return e.copy(r),r}function Uc(e,t){var n=-1,r=e.length;for(t||(t=Array(r));++n<r;)t[n]=e[n];return t}function ev(e,t){for(var n=-1,r=e==null?0:e.length,o=0,i=[];++n<r;){var a=e[n];t(a,n,e)&&(i[o++]=a)}return i}function Yc(){return[]}var tv=Object.prototype,nv=tv.propertyIsEnumerable,ls=Object.getOwnPropertySymbols,rv=ls?function(e){return e==null?[]:(e=Object(e),ev(ls(e),function(t){return nv.call(e,t)}))}:Yc;const qi=rv;function ov(e,t){return jr(e,qi(e),t)}function Gc(e,t){for(var n=-1,r=t.length,o=e.length;++n<r;)e[o+n]=t[n];return e}var iv=Object.getOwnPropertySymbols,av=iv?function(e){for(var t=[];e;)Gc(t,qi(e)),e=zi(e);return t}:Yc;const Xc=av;function sv(e,t){return jr(e,Xc(e),t)}function qc(e,t,n){var r=t(e);return Rn(e)?r:Gc(r,n(e))}function uv(e){return qc(e,Gi,qi)}function cv(e){return qc(e,Xi,Xc)}var lv=Ct(je,"DataView");const qo=lv;var fv=Ct(je,"Promise");const Ko=fv;var pv=Ct(je,"Set");const Zo=pv;var dv=Ct(je,"WeakMap");const Qo=dv;var fs="[object Map]",hv="[object Object]",ps="[object Promise]",ds="[object Set]",hs="[object WeakMap]",ms="[object DataView]",mv=Pt(qo),vv=Pt(En),gv=Pt(Ko),yv=Pt(Zo),bv=Pt(Qo),ft=xt;(qo&&ft(new qo(new ArrayBuffer(1)))!=ms||En&&ft(new En)!=fs||Ko&&ft(Ko.resolve())!=ps||Zo&&ft(new Zo)!=ds||Qo&&ft(new Qo)!=hs)&&(ft=function(e){var t=xt(e),n=t==hv?e.constructor:void 0,r=n?Pt(n):"";if(r)switch(r){case mv:return ms;case vv:return fs;case gv:return ps;case yv:return ds;case bv:return hs}return t});const Ki=ft;var wv=Object.prototype,xv=wv.hasOwnProperty;function Ov(e){var t=e.length,n=new e.constructor(t);return t&&typeof e[0]=="string"&&xv.call(e,"index")&&(n.index=e.index,n.input=e.input),n}var Pv=je.Uint8Array;const vs=Pv;function Zi(e){var t=new e.constructor(e.byteLength);return new vs(t).set(new vs(e)),t}function Cv(e,t){var n=t?Zi(e.buffer):e.buffer;return new e.constructor(n,e.byteOffset,e.byteLength)}var Sv=/\w*$/;function Ev(e){var t=new e.constructor(e.source,Sv.exec(e));return t.lastIndex=e.lastIndex,t}var gs=Xe?Xe.prototype:void 0,ys=gs?gs.valueOf:void 0;function Tv(e){return ys?Object(ys.call(e)):{}}function _v(e,t){var n=t?Zi(e.buffer):e.buffer;return new e.constructor(n,e.byteOffset,e.length)}var Mv="[object Boolean]",$v="[object Date]",jv="[object Map]",Av="[object Number]",Dv="[object RegExp]",kv="[object Set]",Nv="[object String]",Rv="[object Symbol]",Iv="[object ArrayBuffer]",Lv="[object DataView]",Wv="[object Float32Array]",Fv="[object Float64Array]",Bv="[object Int8Array]",Hv="[object Int16Array]",Vv="[object Int32Array]",zv="[object Uint8Array]",Uv="[object Uint8ClampedArray]",Yv="[object Uint16Array]",Gv="[object Uint32Array]";function Xv(e,t,n){var r=e.constructor;switch(t){case Iv:return Zi(e);case Mv:case $v:return new r(+e);case Lv:return Cv(e,n);case Wv:case Fv:case Bv:case Hv:case Vv:case zv:case Uv:case Yv:case Gv:return _v(e,n);case jv:return new r;case Av:case Nv:return new r(e);case Dv:return Ev(e);case kv:return new r;case Rv:return Tv(e)}}var bs=Object.create,qv=function(){function e(){}return function(t){if(!Nn(t))return{};if(bs)return bs(t);e.prototype=t;var n=new e;return e.prototype=void 0,n}}();const Kv=qv;function Zv(e){return typeof e.constructor=="function"&&!Yi(e)?Kv(zi(e)):{}}var Qv="[object Map]";function Jv(e){return Ot(e)&&Ki(e)==Qv}var ws=Gt&&Gt.isMap,eg=ws?Ui(ws):Jv;const tg=eg;var ng="[object Set]";function rg(e){return Ot(e)&&Ki(e)==ng}var xs=Gt&&Gt.isSet,og=xs?Ui(xs):rg;const ig=og;var ag=1,sg=2,ug=4,Kc="[object Arguments]",cg="[object Array]",lg="[object Boolean]",fg="[object Date]",pg="[object Error]",Zc="[object Function]",dg="[object GeneratorFunction]",hg="[object Map]",mg="[object Number]",Qc="[object Object]",vg="[object RegExp]",gg="[object Set]",yg="[object String]",bg="[object Symbol]",wg="[object WeakMap]",xg="[object ArrayBuffer]",Og="[object DataView]",Pg="[object Float32Array]",Cg="[object Float64Array]",Sg="[object Int8Array]",Eg="[object Int16Array]",Tg="[object Int32Array]",_g="[object Uint8Array]",Mg="[object Uint8ClampedArray]",$g="[object Uint16Array]",jg="[object Uint32Array]",H={};H[Kc]=H[cg]=H[xg]=H[Og]=H[lg]=H[fg]=H[Pg]=H[Cg]=H[Sg]=H[Eg]=H[Tg]=H[hg]=H[mg]=H[Qc]=H[vg]=H[gg]=H[yg]=H[bg]=H[_g]=H[Mg]=H[$g]=H[jg]=!0;H[pg]=H[Zc]=H[wg]=!1;function dr(e,t,n,r,o,i){var a,s=t&ag,u=t&sg,c=t&ug;if(n&&(a=o?n(e,r,o,i):n(e)),a!==void 0)return a;if(!Nn(e))return e;var l=Rn(e);if(l){if(a=Ov(e),!s)return Uc(e,a)}else{var d=Ki(e),p=d==Zc||d==dg;if(Wc(e))return Jm(e,s);if(d==Qc||d==Kc||p&&!o){if(a=u||p?{}:Zv(e),!s)return u?sv(e,Zm(a,e)):ov(e,Ym(a,e))}else{if(!H[d])return o?e:{};a=Xv(e,d,s)}}i||(i=new Zt);var m=i.get(e);if(m)return m;i.set(e,a),ig(e)?e.forEach(function(y){a.add(dr(y,t,n,y,e,i))}):tg(e)&&e.forEach(function(y,v){a.set(v,dr(y,t,n,v,e,i))});var b=c?u?cv:uv:u?Xi:Gi,g=l?void 0:b(e);return zh(g||e,function(y,v){g&&(v=y,y=e[v]),Rc(a,v,dr(y,t,n,v,e,i))}),a}var Ag=4;function Os(e){return dr(e,Ag)}function Jc(e,t){for(var n=-1,r=e==null?0:e.length,o=Array(r);++n<r;)o[n]=t(e[n],n,e);return o}var Dg="[object Symbol]";function Qi(e){return typeof e=="symbol"||Ot(e)&&xt(e)==Dg}var kg="Expected a function";function Ji(e,t){if(typeof e!="function"||t!=null&&typeof t!="function")throw new TypeError(kg);var n=function(){var r=arguments,o=t?t.apply(this,r):r[0],i=n.cache;if(i.has(o))return i.get(o);var a=e.apply(this,r);return n.cache=i.set(o,a)||i,a};return n.cache=new(Ji.Cache||Je),n}Ji.Cache=Je;var Ng=500;function Rg(e){var t=Ji(e,function(r){return n.size===Ng&&n.clear(),r}),n=t.cache;return t}var Ig=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,Lg=/\\(\\)?/g,Wg=Rg(function(e){var t=[];return e.charCodeAt(0)===46&&t.push(""),e.replace(Ig,function(n,r,o,i){t.push(o?i.replace(Lg,"$1"):r||n)}),t});const Fg=Wg;var Bg=1/0;function Hg(e){if(typeof e=="string"||Qi(e))return e;var t=e+"";return t=="0"&&1/e==-Bg?"-0":t}var Vg=1/0,Ps=Xe?Xe.prototype:void 0,Cs=Ps?Ps.toString:void 0;function el(e){if(typeof e=="string")return e;if(Rn(e))return Jc(e,el)+"";if(Qi(e))return Cs?Cs.call(e):"";var t=e+"";return t=="0"&&1/e==-Vg?"-0":t}function zg(e){return e==null?"":el(e)}function tl(e){return Rn(e)?Jc(e,Hg):Qi(e)?[e]:Uc(Fg(zg(e)))}function G(){return G=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},G.apply(this,arguments)}function nl(e,t){if(e==null)return{};var n={},r=Object.keys(e),o,i;for(i=0;i<r.length;i++)o=r[i],!(t.indexOf(o)>=0)&&(n[o]=e[o]);return n}var Ar=P.createContext(void 0);Ar.displayName="FormikContext";Ar.Provider;Ar.Consumer;function Ug(){var e=P.useContext(Ar);return e||Xd(!1),e}var be=function(t){return typeof t=="function"},Dr=function(t){return t!==null&&typeof t=="object"},Yg=function(t){return String(Math.floor(Number(t)))===t},so=function(t){return Object.prototype.toString.call(t)==="[object String]"},uo=function(t){return Dr(t)&&be(t.then)};function le(e,t,n,r){r===void 0&&(r=0);for(var o=tl(t);e&&r<o.length;)e=e[o[r++]];return r!==o.length&&!e||e===void 0?n:e}function mt(e,t,n){for(var r=Os(e),o=r,i=0,a=tl(t);i<a.length-1;i++){var s=a[i],u=le(e,a.slice(0,i+1));if(u&&(Dr(u)||Array.isArray(u)))o=o[s]=Os(u);else{var c=a[i+1];o=o[s]=Yg(c)&&Number(c)>=0?[]:{}}}return(i===0?e:o)[a[i]]===n?e:(n===void 0?delete o[a[i]]:o[a[i]]=n,i===0&&n===void 0&&delete r[a[i]],r)}function rl(e,t,n,r){n===void 0&&(n=new WeakMap),r===void 0&&(r={});for(var o=0,i=Object.keys(e);o<i.length;o++){var a=i[o],s=e[a];Dr(s)?n.get(s)||(n.set(s,!0),r[a]=Array.isArray(s)?[]:{},rl(s,t,n,r[a])):r[a]=t}return r}function Gg(e,t){switch(t.type){case"SET_VALUES":return G({},e,{values:t.payload});case"SET_TOUCHED":return G({},e,{touched:t.payload});case"SET_ERRORS":return lt(e.errors,t.payload)?e:G({},e,{errors:t.payload});case"SET_STATUS":return G({},e,{status:t.payload});case"SET_ISSUBMITTING":return G({},e,{isSubmitting:t.payload});case"SET_ISVALIDATING":return G({},e,{isValidating:t.payload});case"SET_FIELD_VALUE":return G({},e,{values:mt(e.values,t.payload.field,t.payload.value)});case"SET_FIELD_TOUCHED":return G({},e,{touched:mt(e.touched,t.payload.field,t.payload.value)});case"SET_FIELD_ERROR":return G({},e,{errors:mt(e.errors,t.payload.field,t.payload.value)});case"RESET_FORM":return G({},e,t.payload);case"SET_FORMIK_STATE":return t.payload(e);case"SUBMIT_ATTEMPT":return G({},e,{touched:rl(e.values,!0),isSubmitting:!0,submitCount:e.submitCount+1});case"SUBMIT_FAILURE":return G({},e,{isSubmitting:!1});case"SUBMIT_SUCCESS":return G({},e,{isSubmitting:!1});default:return e}}var at={},Gn={};function ol(e){var t=e.validateOnChange,n=t===void 0?!0:t,r=e.validateOnBlur,o=r===void 0?!0:r,i=e.validateOnMount,a=i===void 0?!1:i,s=e.isInitialValid,u=e.enableReinitialize,c=u===void 0?!1:u,l=e.onSubmit,d=nl(e,["validateOnChange","validateOnBlur","validateOnMount","isInitialValid","enableReinitialize","onSubmit"]),p=G({validateOnChange:n,validateOnBlur:o,validateOnMount:a,onSubmit:l},d),m=P.useRef(p.initialValues),b=P.useRef(p.initialErrors||at),g=P.useRef(p.initialTouched||Gn),y=P.useRef(p.initialStatus),v=P.useRef(!1),w=P.useRef({});P.useEffect(function(){return v.current=!0,function(){v.current=!1}},[]);var O=P.useState(0),S=O[1],T=P.useRef({values:p.initialValues,errors:p.initialErrors||at,touched:p.initialTouched||Gn,status:p.initialStatus,isSubmitting:!1,isValidating:!1,submitCount:0}),C=T.current,E=P.useCallback(function(x){var M=T.current;T.current=Gg(M,x),M!==T.current&&S(function($){return $+1})},[]),D=P.useCallback(function(x,M){return new Promise(function($,A){var I=p.validate(x,M);I==null?$(at):uo(I)?I.then(function(W){$(W||at)},function(W){A(W)}):$(I)})},[p.validate]),k=P.useCallback(function(x,M){var $=p.validationSchema,A=be($)?$(M):$,I=M&&A.validateAt?A.validateAt(M,x):qg(x,A);return new Promise(function(W,U){I.then(function(){W(at)},function(De){De.name==="ValidationError"?W(Xg(De)):U(De)})})},[p.validationSchema]),R=P.useCallback(function(x,M){return new Promise(function($){return $(w.current[x].validate(M))})},[]),F=P.useCallback(function(x){var M=Object.keys(w.current).filter(function(A){return be(w.current[A].validate)}),$=M.length>0?M.map(function(A){return R(A,le(x,A))}):[Promise.resolve("DO_NOT_DELETE_YOU_WILL_BE_FIRED")];return Promise.all($).then(function(A){return A.reduce(function(I,W,U){return W==="DO_NOT_DELETE_YOU_WILL_BE_FIRED"||W&&(I=mt(I,M[U],W)),I},{})})},[R]),q=P.useCallback(function(x){return Promise.all([F(x),p.validationSchema?k(x):{},p.validate?D(x):{}]).then(function(M){var $=M[0],A=M[1],I=M[2],W=Go.all([$,A,I],{arrayMerge:Kg});return W})},[p.validate,p.validationSchema,F,D,k]),L=de(function(x){return x===void 0&&(x=C.values),E({type:"SET_ISVALIDATING",payload:!0}),q(x).then(function(M){return v.current&&(E({type:"SET_ISVALIDATING",payload:!1}),E({type:"SET_ERRORS",payload:M})),M})});P.useEffect(function(){a&&v.current===!0&&lt(m.current,p.initialValues)&&L(m.current)},[a,L]);var K=P.useCallback(function(x){var M=x&&x.values?x.values:m.current,$=x&&x.errors?x.errors:b.current?b.current:p.initialErrors||{},A=x&&x.touched?x.touched:g.current?g.current:p.initialTouched||{},I=x&&x.status?x.status:y.current?y.current:p.initialStatus;m.current=M,b.current=$,g.current=A,y.current=I;var W=function(){E({type:"RESET_FORM",payload:{isSubmitting:!!x&&!!x.isSubmitting,errors:$,touched:A,status:I,values:M,isValidating:!!x&&!!x.isValidating,submitCount:x&&x.submitCount&&typeof x.submitCount=="number"?x.submitCount:0}})};if(p.onReset){var U=p.onReset(C.values,an);uo(U)?U.then(W):W()}else W()},[p.initialErrors,p.initialStatus,p.initialTouched,p.onReset]);P.useEffect(function(){v.current===!0&&!lt(m.current,p.initialValues)&&c&&(m.current=p.initialValues,K(),a&&L(m.current))},[c,p.initialValues,K,a,L]),P.useEffect(function(){c&&v.current===!0&&!lt(b.current,p.initialErrors)&&(b.current=p.initialErrors||at,E({type:"SET_ERRORS",payload:p.initialErrors||at}))},[c,p.initialErrors]),P.useEffect(function(){c&&v.current===!0&&!lt(g.current,p.initialTouched)&&(g.current=p.initialTouched||Gn,E({type:"SET_TOUCHED",payload:p.initialTouched||Gn}))},[c,p.initialTouched]),P.useEffect(function(){c&&v.current===!0&&!lt(y.current,p.initialStatus)&&(y.current=p.initialStatus,E({type:"SET_STATUS",payload:p.initialStatus}))},[c,p.initialStatus,p.initialTouched]);var re=de(function(x){if(w.current[x]&&be(w.current[x].validate)){var M=le(C.values,x),$=w.current[x].validate(M);return uo($)?(E({type:"SET_ISVALIDATING",payload:!0}),$.then(function(A){return A}).then(function(A){E({type:"SET_FIELD_ERROR",payload:{field:x,value:A}}),E({type:"SET_ISVALIDATING",payload:!1})})):(E({type:"SET_FIELD_ERROR",payload:{field:x,value:$}}),Promise.resolve($))}else if(p.validationSchema)return E({type:"SET_ISVALIDATING",payload:!0}),k(C.values,x).then(function(A){return A}).then(function(A){E({type:"SET_FIELD_ERROR",payload:{field:x,value:le(A,x)}}),E({type:"SET_ISVALIDATING",payload:!1})});return Promise.resolve()}),V=P.useCallback(function(x,M){var $=M.validate;w.current[x]={validate:$}},[]),Y=P.useCallback(function(x){delete w.current[x]},[]),J=de(function(x,M){E({type:"SET_TOUCHED",payload:x});var $=M===void 0?o:M;return $?L(C.values):Promise.resolve()}),ce=P.useCallback(function(x){E({type:"SET_ERRORS",payload:x})},[]),rt=de(function(x,M){var $=be(x)?x(C.values):x;E({type:"SET_VALUES",payload:$});var A=M===void 0?n:M;return A?L($):Promise.resolve()}),Be=P.useCallback(function(x,M){E({type:"SET_FIELD_ERROR",payload:{field:x,value:M}})},[]),pe=de(function(x,M,$){E({type:"SET_FIELD_VALUE",payload:{field:x,value:M}});var A=$===void 0?n:$;return A?L(mt(C.values,x,M)):Promise.resolve()}),ot=P.useCallback(function(x,M){var $=M,A=x,I;if(!so(x)){x.persist&&x.persist();var W=x.target?x.target:x.currentTarget,U=W.type,De=W.name,ro=W.id,oo=W.value,lf=W.checked,n3=W.outerHTML,Da=W.options,ff=W.multiple;$=M||De||ro,A=/number|range/.test(U)?(I=parseFloat(oo),isNaN(I)?"":I):/checkbox/.test(U)?Qg(le(C.values,$),lf,oo):Da&&ff?Zg(Da):oo}$&&pe($,A)},[pe,C.values]),Oe=de(function(x){if(so(x))return function(M){return ot(M,x)};ot(x)}),ee=de(function(x,M,$){M===void 0&&(M=!0),E({type:"SET_FIELD_TOUCHED",payload:{field:x,value:M}});var A=$===void 0?o:$;return A?L(C.values):Promise.resolve()}),He=P.useCallback(function(x,M){x.persist&&x.persist();var $=x.target,A=$.name,I=$.id,W=$.outerHTML,U=M||A||I;ee(U,!0)},[ee]),Ve=de(function(x){if(so(x))return function(M){return He(M,x)};He(x)}),Pe=P.useCallback(function(x){be(x)?E({type:"SET_FORMIK_STATE",payload:x}):E({type:"SET_FORMIK_STATE",payload:function(){return x}})},[]),Mt=P.useCallback(function(x){E({type:"SET_STATUS",payload:x})},[]),Vn=P.useCallback(function(x){E({type:"SET_ISSUBMITTING",payload:x})},[]),it=de(function(){return E({type:"SUBMIT_ATTEMPT"}),L().then(function(x){var M=x instanceof Error,$=!M&&Object.keys(x).length===0;if($){var A;try{if(A=eo(),A===void 0)return}catch(I){throw I}return Promise.resolve(A).then(function(I){return v.current&&E({type:"SUBMIT_SUCCESS"}),I}).catch(function(I){if(v.current)throw E({type:"SUBMIT_FAILURE"}),I})}else if(v.current&&(E({type:"SUBMIT_FAILURE"}),M))throw x})}),Jr=de(function(x){x&&x.preventDefault&&be(x.preventDefault)&&x.preventDefault(),x&&x.stopPropagation&&be(x.stopPropagation)&&x.stopPropagation(),it().catch(function(M){console.warn("Warning: An unhandled error was caught from submitForm()",M)})}),an={resetForm:K,validateForm:L,validateField:re,setErrors:ce,setFieldError:Be,setFieldTouched:ee,setFieldValue:pe,setStatus:Mt,setSubmitting:Vn,setTouched:J,setValues:rt,setFormikState:Pe,submitForm:it},eo=de(function(){return l(C.values,an)}),to=de(function(x){x&&x.preventDefault&&be(x.preventDefault)&&x.preventDefault(),x&&x.stopPropagation&&be(x.stopPropagation)&&x.stopPropagation(),K()}),zn=P.useCallback(function(x){return{value:le(C.values,x),error:le(C.errors,x),touched:!!le(C.touched,x),initialValue:le(m.current,x),initialTouched:!!le(g.current,x),initialError:le(b.current,x)}},[C.errors,C.touched,C.values]),Un=P.useCallback(function(x){return{setValue:function($,A){return pe(x,$,A)},setTouched:function($,A){return ee(x,$,A)},setError:function($){return Be(x,$)}}},[pe,ee,Be]),no=P.useCallback(function(x){var M=Dr(x),$=M?x.name:x,A=le(C.values,$),I={name:$,value:A,onChange:Oe,onBlur:Ve};if(M){var W=x.type,U=x.value,De=x.as,ro=x.multiple;W==="checkbox"?U===void 0?I.checked=!!A:(I.checked=!!(Array.isArray(A)&&~A.indexOf(U)),I.value=U):W==="radio"?(I.checked=A===U,I.value=U):De==="select"&&ro&&(I.value=I.value||[],I.multiple=!0)}return I},[Ve,Oe,C.values]),sn=P.useMemo(function(){return!lt(m.current,C.values)},[m.current,C.values]),Ae=P.useMemo(function(){return typeof s<"u"?sn?C.errors&&Object.keys(C.errors).length===0:s!==!1&&be(s)?s(p):s:C.errors&&Object.keys(C.errors).length===0},[s,sn,C.errors,p]),$t=G({},C,{initialValues:m.current,initialErrors:b.current,initialTouched:g.current,initialStatus:y.current,handleBlur:Ve,handleChange:Oe,handleReset:to,handleSubmit:Jr,resetForm:K,setErrors:ce,setFormikState:Pe,setFieldTouched:ee,setFieldValue:pe,setFieldError:Be,setStatus:Mt,setSubmitting:Vn,setTouched:J,setValues:rt,submitForm:it,validateForm:L,validateField:re,isValid:Ae,dirty:sn,unregisterField:Y,registerField:V,getFieldProps:no,getFieldMeta:zn,getFieldHelpers:Un,validateOnBlur:o,validateOnChange:n,validateOnMount:a});return $t}function Xg(e){var t={};if(e.inner){if(e.inner.length===0)return mt(t,e.path,e.message);for(var o=e.inner,n=Array.isArray(o),r=0,o=n?o:o[Symbol.iterator]();;){var i;if(n){if(r>=o.length)break;i=o[r++]}else{if(r=o.next(),r.done)break;i=r.value}var a=i;le(t,a.path)||(t=mt(t,a.path,a.message))}}return t}function qg(e,t,n,r){n===void 0&&(n=!1);var o=Jo(e);return t[n?"validateSync":"validate"](o,{abortEarly:!1,context:r||o})}function Jo(e){var t=Array.isArray(e)?[]:{};for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var r=String(n);Array.isArray(e[r])===!0?t[r]=e[r].map(function(o){return Array.isArray(o)===!0||Qa(o)?Jo(o):o!==""?o:void 0}):Qa(e[r])?t[r]=Jo(e[r]):t[r]=e[r]!==""?e[r]:void 0}return t}function Kg(e,t,n){var r=e.slice();return t.forEach(function(i,a){if(typeof r[a]>"u"){var s=n.clone!==!1,u=s&&n.isMergeableObject(i);r[a]=u?Go(Array.isArray(i)?[]:{},i,n):i}else n.isMergeableObject(i)?r[a]=Go(e[a],i,n):e.indexOf(i)===-1&&r.push(i)}),r}function Zg(e){return Array.from(e).filter(function(t){return t.selected}).map(function(t){return t.value})}function Qg(e,t,n){if(typeof e=="boolean")return!!t;var r=[],o=!1,i=-1;if(Array.isArray(e))r=e,i=e.indexOf(n),o=i>=0;else if(!n||n=="true"||n=="false")return!!t;return t&&n&&!o?r.concat(n):o?r.slice(0,i).concat(r.slice(i+1)):r}var Jg=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u"?P.useLayoutEffect:P.useEffect;function de(e){var t=P.useRef(e);return Jg(function(){t.current=e}),P.useCallback(function(){for(var n=arguments.length,r=new Array(n),o=0;o<n;o++)r[o]=arguments[o];return t.current.apply(void 0,r)},[])}var e1=P.forwardRef(function(e,t){var n=e.action,r=nl(e,["action"]),o=n??"#",i=Ug(),a=i.handleReset,s=i.handleSubmit;return P.createElement("form",G({onSubmit:s,ref:t,onReset:a,action:o},r))});e1.displayName="Form";var il={exports:{}},t1=il.exports=typeof window<"u"&&window.Math==Math?window:typeof self<"u"&&self.Math==Math?self:Function("return this")();typeof __g=="number"&&(__g=t1);var St=il.exports,al={exports:{}},n1=al.exports={version:"2.6.12"};typeof __e=="number"&&(__e=n1);var et=al.exports,r1=function(e){if(typeof e!="function")throw TypeError(e+" is not a function!");return e},o1=r1,sl=function(e,t,n){if(o1(e),t===void 0)return e;switch(n){case 1:return function(r){return e.call(t,r)};case 2:return function(r,o){return e.call(t,r,o)};case 3:return function(r,o,i){return e.call(t,r,o,i)}}return function(){return e.apply(t,arguments)}},tt={},Qt=function(e){return typeof e=="object"?e!==null:typeof e=="function"},i1=Qt,In=function(e){if(!i1(e))throw TypeError(e+" is not an object!");return e},Ln=function(e){try{return!!e()}catch{return!0}},nt=!Ln(function(){return Object.defineProperty({},"a",{get:function(){return 7}}).a!=7}),co,Ss;function ul(){if(Ss)return co;Ss=1;var e=Qt,t=St.document,n=e(t)&&e(t.createElement);return co=function(r){return n?t.createElement(r):{}},co}var cl=!nt&&!Ln(function(){return Object.defineProperty(ul()("div"),"a",{get:function(){return 7}}).a!=7}),Xn=Qt,ea=function(e,t){if(!Xn(e))return e;var n,r;if(t&&typeof(n=e.toString)=="function"&&!Xn(r=n.call(e))||typeof(n=e.valueOf)=="function"&&!Xn(r=n.call(e))||!t&&typeof(n=e.toString)=="function"&&!Xn(r=n.call(e)))return r;throw TypeError("Can't convert object to primitive value")},Es=In,a1=cl,s1=ea,u1=Object.defineProperty;tt.f=nt?Object.defineProperty:function(t,n,r){if(Es(t),n=s1(n,!0),Es(r),a1)try{return u1(t,n,r)}catch{}if("get"in r||"set"in r)throw TypeError("Accessors not supported!");return"value"in r&&(t[n]=r.value),t};var kr=function(e,t){return{enumerable:!(e&1),configurable:!(e&2),writable:!(e&4),value:t}},c1=tt,l1=kr,Jt=nt?function(e,t,n){return c1.f(e,t,l1(1,n))}:function(e,t,n){return e[t]=n,e},f1={}.hasOwnProperty,Et=function(e,t){return f1.call(e,t)},qn=St,lo=et,Ts=sl,p1=Jt,d1=Et,Kn="prototype",Z=function(e,t,n){var r=e&Z.F,o=e&Z.G,i=e&Z.S,a=e&Z.P,s=e&Z.B,u=e&Z.W,c=o?lo:lo[t]||(lo[t]={}),l=c[Kn],d=o?qn:i?qn[t]:(qn[t]||{})[Kn],p,m,b;o&&(n=t);for(p in n)m=!r&&d&&d[p]!==void 0,!(m&&d1(c,p))&&(b=m?d[p]:n[p],c[p]=o&&typeof d[p]!="function"?n[p]:s&&m?Ts(b,qn):u&&d[p]==b?function(g){var y=function(v,w,O){if(this instanceof g){switch(arguments.length){case 0:return new g;case 1:return new g(v);case 2:return new g(v,w)}return new g(v,w,O)}return g.apply(this,arguments)};return y[Kn]=g[Kn],y}(b):a&&typeof b=="function"?Ts(Function.call,b):b,a&&((c.virtual||(c.virtual={}))[p]=b,e&Z.R&&l&&!l[p]&&p1(l,p,b)))};Z.F=1;Z.G=2;Z.S=4;Z.P=8;Z.B=16;Z.W=32;Z.U=64;Z.R=128;var en=Z,h1={}.toString,ll=function(e){return h1.call(e).slice(8,-1)},fo,_s;function fl(){if(_s)return fo;_s=1;var e=ll;return fo=Object("z").propertyIsEnumerable(0)?Object:function(t){return e(t)=="String"?t.split(""):Object(t)},fo}var ta=function(e){if(e==null)throw TypeError("Can't call method on  "+e);return e},m1=fl(),v1=ta,tn=function(e){return m1(v1(e))},g1=Math.ceil,y1=Math.floor,na=function(e){return isNaN(e=+e)?0:(e>0?y1:g1)(e)},b1=na,w1=Math.min,x1=function(e){return e>0?w1(b1(e),9007199254740991):0},O1=na,P1=Math.max,C1=Math.min,S1=function(e,t){return e=O1(e),e<0?P1(e+t,0):C1(e,t)},E1=tn,T1=x1,_1=S1,M1=function(e){return function(t,n,r){var o=E1(t),i=T1(o.length),a=_1(r,i),s;if(e&&n!=n){for(;i>a;)if(s=o[a++],s!=s)return!0}else for(;i>a;a++)if((e||a in o)&&o[a]===n)return e||a||0;return!e&&-1}},pl={exports:{}},$1=!0,j1=et,Ms=St,$s="__core-js_shared__",js=Ms[$s]||(Ms[$s]={});(pl.exports=function(e,t){return js[e]||(js[e]=t!==void 0?t:{})})("versions",[]).push({version:j1.version,mode:"pure",copyright:"© 2020 Denis Pushkarev (zloirock.ru)"});var ra=pl.exports,A1=0,D1=Math.random(),Nr=function(e){return"Symbol(".concat(e===void 0?"":e,")_",(++A1+D1).toString(36))},As=ra("keys"),k1=Nr,oa=function(e){return As[e]||(As[e]=k1(e))},Ds=Et,N1=tn,R1=M1(!1),I1=oa("IE_PROTO"),dl=function(e,t){var n=N1(e),r=0,o=[],i;for(i in n)i!=I1&&Ds(n,i)&&o.push(i);for(;t.length>r;)Ds(n,i=t[r++])&&(~R1(o,i)||o.push(i));return o},ia="constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(","),L1=dl,W1=ia,Rr=Object.keys||function(t){return L1(t,W1)},Ir={};Ir.f=Object.getOwnPropertySymbols;var po={},ks;function Lr(){return ks||(ks=1,po.f={}.propertyIsEnumerable),po}var F1=ta,aa=function(e){return Object(F1(e))},ho,Ns;function B1(){if(Ns)return ho;Ns=1;var e=nt,t=Rr,n=Ir,r=Lr(),o=aa,i=fl(),a=Object.assign;return ho=!a||Ln(function(){var s={},u={},c=Symbol(),l="abcdefghijklmnopqrst";return s[c]=7,l.split("").forEach(function(d){u[d]=d}),a({},s)[c]!=7||Object.keys(a({},u)).join("")!=l})?function(u,c){for(var l=o(u),d=arguments.length,p=1,m=n.f,b=r.f;d>p;)for(var g=i(arguments[p++]),y=m?t(g).concat(m(g)):t(g),v=y.length,w=0,O;v>w;)O=y[w++],(!e||b.call(g,O))&&(l[O]=g[O]);return l}:a,ho}var mo=en;mo(mo.S+mo.F,"Object",{assign:B1()});var H1=et.Object.assign,V1={default:H1,__esModule:!0},z1=V1,U1=Y1(z1);function Y1(e){return e&&e.__esModule?e:{default:e}}var It=U1.default||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Tt=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},Wr={},G1=na,X1=ta,q1=function(e){return function(t,n){var r=String(X1(t)),o=G1(n),i=r.length,a,s;return o<0||o>=i?e?"":void 0:(a=r.charCodeAt(o),a<55296||a>56319||o+1===i||(s=r.charCodeAt(o+1))<56320||s>57343?e?r.charAt(o):a:e?r.slice(o,o+2):(a-55296<<10)+(s-56320)+65536)}},hl=Jt,sa={},K1=tt,Z1=In,Q1=Rr,J1=nt?Object.defineProperties:function(t,n){Z1(t);for(var r=Q1(n),o=r.length,i=0,a;o>i;)K1.f(t,a=r[i++],n[a]);return t},vo,Rs;function ey(){if(Rs)return vo;Rs=1;var e=St.document;return vo=e&&e.documentElement,vo}var ty=In,ny=J1,Is=ia,ry=oa("IE_PROTO"),go=function(){},ei="prototype",hr=function(){var e=ul()("iframe"),t=Is.length,n="<",r=">",o;for(e.style.display="none",ey().appendChild(e),e.src="javascript:",o=e.contentWindow.document,o.open(),o.write(n+"script"+r+"document.F=Object"+n+"/script"+r),o.close(),hr=o.F;t--;)delete hr[ei][Is[t]];return hr()},ua=Object.create||function(t,n){var r;return t!==null?(go[ei]=ty(t),r=new go,go[ei]=null,r[ry]=t):r=hr(),n===void 0?r:ny(r,n)},ml={exports:{}},ti=ra("wks"),oy=Nr,ni=St.Symbol,Ls=typeof ni=="function",iy=ml.exports=function(e){return ti[e]||(ti[e]=Ls&&ni[e]||(Ls?ni:oy)("Symbol."+e))};iy.store=ti;var nn=ml.exports,ay=tt.f,sy=Et,Ws=nn("toStringTag"),ca=function(e,t,n){e&&!sy(e=n?e:e.prototype,Ws)&&ay(e,Ws,{configurable:!0,value:t})},uy=ua,cy=kr,ly=ca,vl={};Jt(vl,nn("iterator"),function(){return this});var fy=function(e,t,n){e.prototype=uy(vl,{next:cy(1,n)}),ly(e,t+" Iterator")},py=Et,dy=aa,Fs=oa("IE_PROTO"),hy=Object.prototype,my=Object.getPrototypeOf||function(e){return e=dy(e),py(e,Fs)?e[Fs]:typeof e.constructor=="function"&&e instanceof e.constructor?e.constructor.prototype:e instanceof Object?hy:null},yo=en,vy=hl,gy=Jt,Bs=sa,yy=fy,by=ca,wy=my,bo=nn("iterator"),wo=!([].keys&&"next"in[].keys()),xy="@@iterator",Hs="keys",Zn="values",Oy=function(){return this},gl=function(e,t,n,r,o,i,a){yy(n,t,r);var s=function(O){if(!wo&&O in d)return d[O];switch(O){case Hs:return function(){return new n(this,O)};case Zn:return function(){return new n(this,O)}}return function(){return new n(this,O)}},u=t+" Iterator",c=o==Zn,l=!1,d=e.prototype,p=d[bo]||d[xy]||o&&d[o],m=p||s(o),b=o?c?s("entries"):m:void 0,g=t=="Array"&&d.entries||p,y,v,w;if(g&&(w=wy(g.call(new e)),w!==Object.prototype&&w.next&&by(w,u,!0)),c&&p&&p.name!==Zn&&(l=!0,m=function(){return p.call(this)}),a&&(wo||l||!d[bo])&&gy(d,bo,m),Bs[t]=m,Bs[u]=Oy,o)if(y={values:c?m:s(Zn),keys:i?m:s(Hs),entries:b},a)for(v in y)v in d||vy(d,v,y[v]);else yo(yo.P+yo.F*(wo||l),t,y);return y},Py=q1(!0);gl(String,"String",function(e){this._t=String(e),this._i=0},function(){var e=this._t,t=this._i,n;return t>=e.length?{value:void 0,done:!0}:(n=Py(e,t),this._i+=n.length,{value:n,done:!1})});var Cy=function(e,t){return{value:t,done:!!e}},Qn=Cy,Vs=sa,Sy=tn;gl(Array,"Array",function(e,t){this._t=Sy(e),this._i=0,this._k=t},function(){var e=this._t,t=this._k,n=this._i++;return!e||n>=e.length?(this._t=void 0,Qn(1)):t=="keys"?Qn(0,n):t=="values"?Qn(0,e[n]):Qn(0,[n,e[n]])},"values");Vs.Arguments=Vs.Array;var Ey=St,Ty=Jt,zs=sa,Us=nn("toStringTag"),Ys="CSSRuleList,CSSStyleDeclaration,CSSValueList,ClientRectList,DOMRectList,DOMStringList,DOMTokenList,DataTransferItemList,FileList,HTMLAllCollection,HTMLCollection,HTMLFormElement,HTMLSelectElement,MediaList,MimeTypeArray,NamedNodeMap,NodeList,PaintRequestList,Plugin,PluginArray,SVGLengthList,SVGNumberList,SVGPathSegList,SVGPointList,SVGStringList,SVGTransformList,SourceBufferList,StyleSheetList,TextTrackCueList,TextTrackList,TouchList".split(",");for(var xo=0;xo<Ys.length;xo++){var Oo=Ys[xo],Gs=Ey[Oo],Po=Gs&&Gs.prototype;Po&&!Po[Us]&&Ty(Po,Us,Oo),zs[Oo]=zs.Array}var Fr={};Fr.f=nn;var _y=Fr.f("iterator"),My={default:_y,__esModule:!0},yl={exports:{}},yt=Nr("meta"),$y=Qt,la=Et,jy=tt.f,Ay=0,Br=Object.isExtensible||function(){return!0},Dy=!Ln(function(){return Br(Object.preventExtensions({}))}),fa=function(e){jy(e,yt,{value:{i:"O"+ ++Ay,w:{}}})},ky=function(e,t){if(!$y(e))return typeof e=="symbol"?e:(typeof e=="string"?"S":"P")+e;if(!la(e,yt)){if(!Br(e))return"F";if(!t)return"E";fa(e)}return e[yt].i},Ny=function(e,t){if(!la(e,yt)){if(!Br(e))return!0;if(!t)return!1;fa(e)}return e[yt].w},Ry=function(e){return Dy&&Iy.NEED&&Br(e)&&!la(e,yt)&&fa(e),e},Iy=yl.exports={KEY:yt,NEED:!1,fastKey:ky,getWeak:Ny,onFreeze:Ry},Ly=yl.exports,Xs=et,Wy=Fr,Fy=tt.f,pa=function(e){var t=Xs.Symbol||(Xs.Symbol={});e.charAt(0)!="_"&&!(e in t)&&Fy(t,e,{value:Wy.f(e)})},By=Rr,Hy=Ir,Vy=Lr(),zy=function(e){var t=By(e),n=Hy.f;if(n)for(var r=n(e),o=Vy.f,i=0,a;r.length>i;)o.call(e,a=r[i++])&&t.push(a);return t},Uy=ll,Yy=Array.isArray||function(t){return Uy(t)=="Array"},bl={},da={},Gy=dl,Xy=ia.concat("length","prototype");da.f=Object.getOwnPropertyNames||function(t){return Gy(t,Xy)};var qy=tn,wl=da.f,Ky={}.toString,xl=typeof window=="object"&&window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[],Zy=function(e){try{return wl(e)}catch{return xl.slice()}};bl.f=function(t){return xl&&Ky.call(t)=="[object Window]"?Zy(t):wl(qy(t))};var ha={},Qy=Lr(),Jy=kr,eb=tn,tb=ea,nb=Et,rb=cl,qs=Object.getOwnPropertyDescriptor;ha.f=nt?qs:function(t,n){if(t=eb(t),n=tb(n,!0),rb)try{return qs(t,n)}catch{}if(nb(t,n))return Jy(!Qy.f.call(t,n),t[n])};var Hr=St,X=Et,ri=nt,Q=en,Ks=hl,ob=Ly.KEY,ma=Ln,va=ra,ga=ca,ib=Nr,Wn=nn,ab=Fr,sb=pa,ub=zy,cb=Yy,oi=In,lb=Qt,fb=aa,Vr=tn,ya=ea,ii=kr,_n=ua,Ol=bl,Pl=ha,zr=Ir,Cl=tt,pb=Rr,Sl=Pl.f,dt=Cl.f,El=Ol.f,se=Hr.Symbol,br=Hr.JSON,Jn=br&&br.stringify,Ge="prototype",oe=Wn("_hidden"),Zs=Wn("toPrimitive"),db={}.propertyIsEnumerable,ln=va("symbol-registry"),We=va("symbols"),Fn=va("op-symbols"),me=Object[Ge],rn=typeof se=="function"&&!!zr.f,Co=Hr.QObject,ai=!Co||!Co[Ge]||!Co[Ge].findChild,si=ri&&ma(function(){return _n(dt({},"a",{get:function(){return dt(this,"a",{value:7}).a}})).a!=7})?function(e,t,n){var r=Sl(me,t);r&&delete me[t],dt(e,t,n),r&&e!==me&&dt(me,t,r)}:dt,Qs=function(e){var t=We[e]=_n(se[Ge]);return t._k=e,t},ui=rn&&typeof se.iterator=="symbol"?function(e){return typeof e=="symbol"}:function(e){return e instanceof se},Ur=function(t,n,r){return t===me&&Ur(Fn,n,r),oi(t),n=ya(n,!0),oi(r),X(We,n)?(r.enumerable?(X(t,oe)&&t[oe][n]&&(t[oe][n]=!1),r=_n(r,{enumerable:ii(0,!1)})):(X(t,oe)||dt(t,oe,ii(1,{})),t[oe][n]=!0),si(t,n,r)):dt(t,n,r)},Tl=function(t,n){oi(t);for(var r=ub(n=Vr(n)),o=0,i=r.length,a;i>o;)Ur(t,a=r[o++],n[a]);return t},hb=function(t,n){return n===void 0?_n(t):Tl(_n(t),n)},Js=function(t){var n=db.call(this,t=ya(t,!0));return this===me&&X(We,t)&&!X(Fn,t)?!1:n||!X(this,t)||!X(We,t)||X(this,oe)&&this[oe][t]?n:!0},_l=function(t,n){if(t=Vr(t),n=ya(n,!0),!(t===me&&X(We,n)&&!X(Fn,n))){var r=Sl(t,n);return r&&X(We,n)&&!(X(t,oe)&&t[oe][n])&&(r.enumerable=!0),r}},Ml=function(t){for(var n=El(Vr(t)),r=[],o=0,i;n.length>o;)!X(We,i=n[o++])&&i!=oe&&i!=ob&&r.push(i);return r},$l=function(t){for(var n=t===me,r=El(n?Fn:Vr(t)),o=[],i=0,a;r.length>i;)X(We,a=r[i++])&&(!n||X(me,a))&&o.push(We[a]);return o};rn||(se=function(){if(this instanceof se)throw TypeError("Symbol is not a constructor!");var t=ib(arguments.length>0?arguments[0]:void 0),n=function(r){this===me&&n.call(Fn,r),X(this,oe)&&X(this[oe],t)&&(this[oe][t]=!1),si(this,t,ii(1,r))};return ri&&ai&&si(me,t,{configurable:!0,set:n}),Qs(t)},Ks(se[Ge],"toString",function(){return this._k}),Pl.f=_l,Cl.f=Ur,da.f=Ol.f=Ml,Lr().f=Js,zr.f=$l,ri&&!$1&&Ks(me,"propertyIsEnumerable",Js),ab.f=function(e){return Qs(Wn(e))});Q(Q.G+Q.W+Q.F*!rn,{Symbol:se});for(var eu="hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),tu=0;eu.length>tu;)Wn(eu[tu++]);for(var nu=pb(Wn.store),ru=0;nu.length>ru;)sb(nu[ru++]);Q(Q.S+Q.F*!rn,"Symbol",{for:function(e){return X(ln,e+="")?ln[e]:ln[e]=se(e)},keyFor:function(t){if(!ui(t))throw TypeError(t+" is not a symbol!");for(var n in ln)if(ln[n]===t)return n},useSetter:function(){ai=!0},useSimple:function(){ai=!1}});Q(Q.S+Q.F*!rn,"Object",{create:hb,defineProperty:Ur,defineProperties:Tl,getOwnPropertyDescriptor:_l,getOwnPropertyNames:Ml,getOwnPropertySymbols:$l});var mb=ma(function(){zr.f(1)});Q(Q.S+Q.F*mb,"Object",{getOwnPropertySymbols:function(t){return zr.f(fb(t))}});br&&Q(Q.S+Q.F*(!rn||ma(function(){var e=se();return Jn([e])!="[null]"||Jn({a:e})!="{}"||Jn(Object(e))!="{}"})),"JSON",{stringify:function(t){for(var n=[t],r=1,o,i;arguments.length>r;)n.push(arguments[r++]);if(i=o=n[1],!(!lb(o)&&t===void 0||ui(t)))return cb(o)||(o=function(a,s){if(typeof i=="function"&&(s=i.call(this,a,s)),!ui(s))return s}),n[1]=o,Jn.apply(br,n)}});se[Ge][Zs]||Jt(se[Ge],Zs,se[Ge].valueOf);ga(se,"Symbol");ga(Math,"Math",!0);ga(Hr.JSON,"JSON",!0);pa("asyncIterator");pa("observable");var vb=et.Symbol,gb={default:vb,__esModule:!0};Wr.__esModule=!0;var yb=My,jl=Al(yb),bb=gb,Ye=Al(bb),So=typeof Ye.default=="function"&&typeof jl.default=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Ye.default=="function"&&e.constructor===Ye.default&&e!==Ye.default.prototype?"symbol":typeof e};function Al(e){return e&&e.__esModule?e:{default:e}}var wb=Wr.default=typeof Ye.default=="function"&&So(jl.default)==="symbol"?function(e){return typeof e>"u"?"undefined":So(e)}:function(e){return e&&typeof Ye.default=="function"&&e.constructor===Ye.default&&e!==Ye.default.prototype?"symbol":typeof e>"u"?"undefined":So(e)},xb=Wr,Ob=Pb(xb);function Pb(e){return e&&e.__esModule?e:{default:e}}var qe=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t&&((typeof t>"u"?"undefined":(0,Ob.default)(t))==="object"||typeof t=="function")?t:e},Eo,ou;function Cb(){if(ou)return Eo;ou=1;var e=Qt,t=In,n=function(r,o){if(t(r),!e(o)&&o!==null)throw TypeError(o+": can't set as prototype!")};return Eo={set:Object.setPrototypeOf||("__proto__"in{}?function(r,o,i){try{i=sl(Function.call,ha.f(Object.prototype,"__proto__").set,2),i(r,[]),o=!(r instanceof Array)}catch{o=!0}return function(s,u){return n(s,u),o?s.__proto__=u:i(s,u),s}}({},!1):void 0),check:n},Eo}var iu=en;iu(iu.S,"Object",{setPrototypeOf:Cb().set});var Sb=et.Object.setPrototypeOf,Eb={default:Sb,__esModule:!0},au=en;au(au.S,"Object",{create:ua});var Tb=et.Object,_b=function(t,n){return Tb.create(t,n)},Mb={default:_b,__esModule:!0},$b=Eb,su=ba($b),jb=Mb,Ab=ba(jb),Db=Wr,kb=ba(Db);function ba(e){return e&&e.__esModule?e:{default:e}}var _t=function(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function, not "+(typeof t>"u"?"undefined":(0,kb.default)(t)));e.prototype=(0,Ab.default)(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(su.default?(0,su.default)(e,t):e.__proto__=t)};function Dl(){var e=this.constructor.getDerivedStateFromProps(this.props,this.state);e!=null&&this.setState(e)}function kl(e){function t(n){var r=this.constructor.getDerivedStateFromProps(e,n);return r??null}this.setState(t.bind(this))}function Nl(e,t){try{var n=this.props,r=this.state;this.props=e,this.state=t,this.__reactInternalSnapshotFlag=!0,this.__reactInternalSnapshot=this.getSnapshotBeforeUpdate(n,r)}finally{this.props=n,this.state=r}}Dl.__suppressDeprecationWarning=!0;kl.__suppressDeprecationWarning=!0;Nl.__suppressDeprecationWarning=!0;function wa(e){var t=e.prototype;if(!t||!t.isReactComponent)throw new Error("Can only polyfill class components");if(typeof e.getDerivedStateFromProps!="function"&&typeof t.getSnapshotBeforeUpdate!="function")return e;var n=null,r=null,o=null;if(typeof t.componentWillMount=="function"?n="componentWillMount":typeof t.UNSAFE_componentWillMount=="function"&&(n="UNSAFE_componentWillMount"),typeof t.componentWillReceiveProps=="function"?r="componentWillReceiveProps":typeof t.UNSAFE_componentWillReceiveProps=="function"&&(r="UNSAFE_componentWillReceiveProps"),typeof t.componentWillUpdate=="function"?o="componentWillUpdate":typeof t.UNSAFE_componentWillUpdate=="function"&&(o="UNSAFE_componentWillUpdate"),n!==null||r!==null||o!==null){var i=e.displayName||e.name,a=typeof e.getDerivedStateFromProps=="function"?"getDerivedStateFromProps()":"getSnapshotBeforeUpdate()";throw Error(`Unsafe legacy lifecycles will not be called for components using new component APIs.
...
`;function ja(e){return e.year===new Date().getFullYear()&&e.month===new Date().getMonth()}const zu=50,Jl=({onClose:e})=>{const t=Kt(),n=ne(_r),{t:r}=xe(),[o,i]=P.useState(250),{handleSubmit:a,values:{date:s,waterAmount:u},errors:c,setFieldValue:l}=ol({initialValues:{waterAmount:"250",date:Ie().format("HH:mm")},onSubmit:g=>{t(bf({credentials:g,shouldUpdateMonth:ja(n)})).unwrap().then(()=>{e()})}}),d=()=>{l("waterAmount",o?o.toString():"0")},p=()=>{const g=Number.parseInt(u)+zu;l("waterAmount",g.toString()),i(g)},m=()=>{const g=Number.parseInt(u)-zu;l("waterAmount",g<=0?"0":g.toString()),i(g<=0?0:g)};function b(g){i(Number.parseInt(isNaN(Number.parseInt(g))?0:g))}return h.jsxs(Fx,{onSubmit:a,children:[h.jsx(Bx,{children:r("addWater")}),h.jsx(Hx,{children:r("addModal.Choose a value")}),h.jsxs(Yx,{children:[r("addModal.Amount of water"),":"]}),h.jsxs(Vx,{children:[h.jsx("button",{onClick:m,name:"minus",type:"button",children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-minus`})})}),h.jsxs("span",{className:"water-amount-value",children:[u,r("ml")]}),h.jsx("button",{onClick:p,name:"plus",type:"button",children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-plus`})})})]}),h.jsxs(zx,{children:[h.jsxs("label",{children:[r("addModal.Recording time"),":",h.jsx(Gx,{defaultValue:Ie(s,"HH:mm"),showSecond:!1,minuteStep:5,onChange:g=>{l("date",g&&g.format("HH:mm"))}}),c.date?h.jsx("div",{children:c.date}):null]}),h.jsxs("label",{children:[r("addModal.Enter the value of the water used"),":",h.jsx("input",{name:"number",value:o,onBlur:d,onChange:({target:{value:g}})=>b(g)}),c.waterAmount?h.jsx("div",{children:c.waterAmount}):null]}),h.jsxs(Ux,{children:[h.jsxs("p",{children:[u,r("ml")]}),h.jsx("button",{disabled:Object.keys(c).length>0,type:"submit",children:r("save")})]})]})]})},Xx=_.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,Yu=_.p`
  ...
  position: absolute;
  bottom: -17px;
`,c2=()=>{const{gender:e}=ne(Er),[t,n]=P.useState("0"),[r,o]=P.useState("0"),[i,a]=P.useState("1.8"),[s,u]=P.useState(()=>m()),{t:c}=xe(),l=uc({weight:Ia().typeError(c("normaModal.Weight must be a number")).min(3,c("normaModal.Weight must be more than 3kg")).max(300,c("normaModal.Weight must be less than 300kg")),sports:Ia().typeError(c("normaModal.Time must be a number")).positive(c("normaModal.Time must be more than 0"))}),{control:d,formState:{errors:p}}=cc({mode:"onChange",resolver:lc(l),defaultValues:{weight:"",sports:""}});P.useEffect(()=>{if(s&&t>0){const g=t*.03+r*.4;a(g.toFixed(1))}if(!s&&t>0){const g=t*.04+r*.6;a(g.toFixed(1))}},[t,r,s,a]);function m(){return e==="female"||e===null}function b(){return e==="female"||e===null?"female":"male"}return h.jsxs(h.Fragment,{children:[h.jsxs("form",{children:[h.jsxs(wf,{defaultValue:b(),name:"radio-buttons-group",row:!0,sx:{marginBottom:"16px"},children:[h.jsx(La,{value:"female",control:h.jsx(Wa,{}),label:c("normaModal.For woman"),onChange:()=>u(!0),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25,letterSpacing:"0"},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}}),h.jsx(La,{value:"male",control:h.jsx(Wa,{}),label:c("normaModal.For man"),onChange:()=>u(!1),sx:{"& .MuiSvgIcon-root":{fontSize:18},"& .MuiFormControlLabel-label":{fontSize:16,lineHeight:1.25},"& .MuiRadio-colorPrimary":{color:"#407bff"},"& .MuiRadio-colorPrimary.Mui-checked":{color:"#407bff"}}})]}),h.jsxs(i2,{children:[h.jsxs(Uu,{children:[h.jsxs("label",{htmlFor:"weight",children:[c("normaModal.Your weight in kilograms"),":"]}),h.jsx(Fa,{name:"weight",control:d,render:({field:{onChange:g,...y}})=>h.jsx("input",{id:"weight",...y,onChange:({target:{value:v}})=>{g(v),n(v)},placeholder:"0",onFocus:v=>v.target.placeholder="",onBlur:v=>v.target.placeholder="0",onInput:v=>{v.target.value=v.target.value.replace(/(\.\d{1})\d+/,"$1"),v.target.value=v.target.value.replace(",",".")},autoComplete:"off"})}),p.weight&&t!==""&&h.jsx(Yu,{children:p.weight.message})]}),h.jsxs(Uu,{children:[h.jsxs("label",{htmlFor:"sports",children:[c("normaModal.The time of active participation in sports or other activities with a high physical load in hours"),":"]}),h.jsx(Fa,{name:"sports",control:d,render:({field:{onChange:g,...y}})=>h.jsx("input",{id:"sports",...y,onChange:({target:{value:v}})=>{g(v),o(v)},placeholder:"0",onFocus:v=>v.target.placeholder="",onBlur:v=>v.target.placeholder="0",onInput:v=>{v.target.value=v.target.value.replace(/(\.\d{1})\d+/,"$1"),v.target.value=v.target.value.replace(",",".")},autoComplete:"off"})}),p.sports&&r!==""&&h.jsx(Yu,{children:p.sports.message})]})]})]}),h.jsxs(o2,{children:[h.jsxs("p",{children:[c("normaModal.The required amount of water in liters per day"),":"]}),h.jsx("p",{children:h.jsxs("span",{children:[i," ",c("normaModal.L")]})})]})]})},l2=({onClose:e})=>{const t=Kt(),n=ne(_r),{waterRate:r}=ne(Er),{t:o}=xe(),i=uc({norma:xf().matches(/^(0\.1|[1-9](\.\d)?|1[0-4](\.\d)?|15)$/,o("normaModal.normaError")).required()}),{register:a,handleSubmit:s,formState:{errors:u}}=cc({defaultValues:{norma:r/1e3},mode:"onChange",resolver:lc(i)});async function c(l){const p={waterRate:(l.norma*1e3).toString()};t(Of(p)).unwrap().then(()=>{t(fc({year:n.year,month:n.month+1})),e()}).catch(m=>{Pf.Notify.failure(m.message,Cf)})}return h.jsxs(t2,{children:[h.jsx("h2",{children:o("normaModal.My daily norma")}),h.jsxs(n2,{children:[h.jsxs("p",{children:[o("normaModal.formulaGenderF"),": ",h.jsx("span",{children:"V=(M*0,03) + (T*0,4)"})]}),h.jsxs("p",{children:[o("normaModal.formulaGenderM"),": ",h.jsx("span",{children:"V=(M*0,04) + (T*0,6)"})]})]}),h.jsxs(r2,{children:[h.jsx("span",{children:"*"})," ",o("normaModal.explanation")]}),h.jsxs("h3",{children:[o("normaModal.Calculate your rate"),":"]}),h.jsx(c2,{}),h.jsxs("form",{action:"",onSubmit:s(c),children:[h.jsxs(a2,{children:[h.jsxs("label",{htmlFor:"norma",children:[o("normaModal. Write down how much water you will drink"),":"]}),h.jsx("input",{type:"text",...a("norma",{max:15}),name:"norma",id:"norma",placeholder:"0",onFocus:l=>l.target.placeholder="",onBlur:l=>l.target.placeholder="0",onInput:l=>{l.target.value=l.target.value.replace(/(\.\d{1})\d+/,"$1"),l.target.value=l.target.value.replace(",",".")},autoComplete:"off"}),u.norma&&h.jsx(u2,{children:u.norma.message})]}),h.jsx(s2,{children:h.jsx(sc,{type:"submit",children:o("save")})})]})]})},f2=_.div`
  width: 198px;
`,p2=_.div`
  width: 164px;
`,Gu=_.div`
...
`,Vo=new Date,yO=()=>{const e=ne(vd),[t,n]=P.useState(Vo.getMonth()),[r,o]=P.useState(Vo.getFullYear()),i=Kt(),{i18n:a}=xe(),s=sO(t),u=oO(t,r),c=rO(u,s),l=c==null?void 0:c.map(m=>Object.values(e).find(g=>rc(g.date)===rc(m.date))||m);P.useEffect(()=>{i(fc({year:r,month:t+1})),i(Mf({year:r,month:t}))},[i,r,t]);const d=({currentTarget:m})=>{t===0?(o(b=>b-1),n(11)):n(b=>b-1),m.blur()},p=({currentTarget:m})=>{t===11?(o(b=>b+1),n(0)):n(b=>b+1),m.blur()};return h.jsxs(h.Fragment,{children:[h.jsxs(hO,{children:[h.jsx(gO,{children:a.t("month")}),h.jsxs(mO,{children:[h.jsx(oc,{onClick:d,children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-arrow-left`})})}),h.jsxs("span",{style:{textTransform:"capitalize"},children:[Di(new Date(r,t,1),"LLLL",{locale:a.language==="uk"?nc:Zu}),", ",r]}),h.jsx(oc,{onClick:p,disabled:Vo<new Date(r,t+1),children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-arrow-right`})})})]})]}),h.jsx(vO,{children:l.map((m,b)=>{const g=Di(new Date(r,t,b+1),"LLLL",{locale:a.language==="uk"?nc:Zu});return h.jsx(dO,{item:m,index:b,monthName:g},b)})})]})},bO=_.div`
  width: 100%;
...
`,wO=({onClose:e,id:t})=>{const n=Kt(),{t:r}=xe(),o=ne(_r);function i(){n($f({portionId:t,shouldUpdateMonth:ja(o)})).unwrap().then(()=>e())}return h.jsxs(bO,{children:[h.jsx("h2",{children:r("deleteModal.Delete entry")}),h.jsx("p",{className:"text",children:r("deleteModal.Are you sure you want to delete the entry?")}),h.jsxs("div",{className:"wrapper-btn",children:[h.jsx("button",{onClick:e,className:"cancel-btn",children:r("deleteModal.Cancel")}),h.jsx("button",{onClick:i,className:"delete-btn",children:r("deleteModal.Delete")})]})]})},xO=_.button`
  padding: 0;
  border: none;
  background-color: transparent;
  position: relative;
...
`,ic=20,NO=({onClose:e,id:t})=>{const{t:n}=xe(),r=Kt(),o=ne(_r),a=ne(Vi).find(w=>w._id===t),[s,u]=P.useState(a.waterAmount),{handleSubmit:c,values:{date:l,waterAmount:d},errors:p,setFieldValue:m}=ol({initialValues:{waterAmount:a.waterAmount.toString(),date:Ie().format("HH:mm")},onSubmit:w=>{r(jf({portionId:t,credentials:w,shouldUpdateMonth:ja(o)})).unwrap().then(()=>{e()})}}),b=()=>{m("waterAmount",s?s.toString():"0")},g=()=>{const w=Number.parseInt(d)+ic;m("waterAmount",w.toString()),u(w)},y=()=>{const w=Number.parseInt(d)-ic;m("waterAmount",w<=0?"0":w.toString()),u(w<=0?0:w)};function v(w){u(Number.parseInt(isNaN(Number.parseInt(w))?0:w))}return h.jsxs(PO,{onSubmit:c,children:[h.jsx(CO,{children:"Edit the entered amount of water"}),h.jsxs($O,{children:[h.jsx(EO,{}),h.jsxs(jO,{children:[a.waterAmount,n("ml")]}),h.jsxs(AO,{children:[" ",Di(w0(a.date,2),"HH:mm")]})]}),h.jsx(SO,{children:"Correct entered data"}),h.jsxs(DO,{children:[n("addModal.Amount of water"),":"]}),h.jsxs(TO,{children:[h.jsx("button",{onClick:y,name:"minus",type:"button",children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-minus`})})}),h.jsxs("span",{className:"water-amount-value",children:[d,n("ml")]}),h.jsx("button",{onClick:g,name:"plus",type:"button",children:h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-plus`})})})]}),h.jsxs(_O,{children:[h.jsxs("label",{children:[n("addModal.Recording time"),":",h.jsx(kO,{defaultValue:Ie(l,"HH:mm"),showSecond:!1,minuteStep:5,onChange:w=>{m("date",w&&w.format("HH:mm"))}}),p.date?h.jsx("div",{children:p.date}):null]}),h.jsxs("label",{children:[n("addModal.Enter the value of the water used"),":",h.jsx("input",{name:"number",value:s,onBlur:b,onChange:({target:{value:w}})=>v(w)}),p.waterAmount?h.jsx("div",{children:p.waterAmount}):null]}),h.jsxs(MO,{children:[h.jsxs("p",{children:[d,n("ml")]}),h.jsx("button",{disabled:Object.keys(p).length>0,type:"submit",children:n("save")})]})]})]})},RO=_.button`
  padding: 0;
  border: none;
  background-color: transparent;
  position: relative;
...
`,UO=()=>{const e=ne(Vi),[t,n]=P.useState(!1),[r,o]=P.useState(!1),{t:i}=xe(),a=c=>{o(!0),n(!1),c.stopPropagation()},s=()=>{o(!1)},u=[...e].sort((c,l)=>{const d=new Date(c.date);return new Date(l.date)-d});return h.jsxs(LO,{children:[u.length>0&&h.jsx(WO,{children:u==null?void 0:u.map(c=>h.jsxs(FO,{children:[h.jsx(cf,{className:"glass"}),h.jsxs(BO,{children:[`${c.waterAmount} ${i("ml")}`," "]}),h.jsx(HO,{children:aO(c.date)}),h.jsxs(VO,{children:[h.jsx(IO,{id:c._id}),h.jsx(OO,{id:c._id})]})]},c._id))}),h.jsxs(zO,{onClick:c=>a(c),children:[h.jsx("svg",{children:h.jsx("use",{href:`${Me}#icon-plus`})}),i("addWater")]}),r&&h.jsx(An,{$position:"center",open:r,onClose:s,children:h.jsx(Jl,{onClose:s,isEditing:t})})]})},YO=_.div`
  margin-bottom: 24px;
`,GO=_.h2`
  margin-bottom: 16px;
  font-size: 24px;
...
font-size: 18px;
 color: ${e=>e.theme.colors.secondaryBlue};
 margin-bottom: 16px;
`,qO=()=>{const e=Kt(),t=ne(Vi),[n,r]=P.useState(!1),{t:o}=xe();return P.useEffect(()=>{e(Af())},[e]),P.useEffect(()=>{t.length===0?r(!0):r(!1)},[t]),h.jsxs(YO,{children:[h.jsx(GO,{children:o("today")}),n&&h.jsx(XO,{children:"No notes yet"}),h.jsx(UO,{})]})},KO=_.div`
  width: 280px;
  padding: 24px 8px;
  border-radius: 10px;
...
`,o3=()=>h.jsx(t3,{id:"beckground",children:h.jsxs(QO,{children:[h.jsxs(JO,{children:[h.jsx(d2,{}),h.jsx(e2,{})]}),h.jsx(e3,{children:h.jsx(ZO,{})})]})});export{o3 as default};
